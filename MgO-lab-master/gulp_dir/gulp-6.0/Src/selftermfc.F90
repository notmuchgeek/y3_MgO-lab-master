  subroutine selftermfc(erecip,ec6,derive0self,factor,fct,ofct,ospfct,dfct,npotl,npots, &
...
!
        d2cell(ix,jx,nd2central) = d2cell(ix,jx,nd2central) - apt
        d2cell(iy,jy,nd2central) = d2cell(iy,jy,nd2central) - apt
        d2cell(iz,jz,nd2central) = d2cell(iz,jz,nd2central) - apt
      endif
    enddo
  endif
  if (lewaldtype) then
...
!
      d2cell(ix,jx,nd2central) = d2cell(ix,jx,nd2central) - setrm
      d2cell(iy,jy,nd2central) = d2cell(iy,jy,nd2central) - setrm
      d2cell(iz,jz,nd2central) = d2cell(iz,jz,nd2central) - setrm
    endif
  endif
#ifdef TRACE
  call trace_out('selftermfc')
#endif
!
  return
  end
