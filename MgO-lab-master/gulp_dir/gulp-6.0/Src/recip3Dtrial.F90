...
!   7/20 Sumall removed since not needed
!
!  Conditions of use:
!
...
!
  ...
  if (status/=0) call outofmemory('recip3Dtrial','ktrm6')
!
!  Setup
!
  eta4 = 0.25_dp/eta
...
!
  ...
  if (status/=0) call deallocate_error('recip3Dtrial','ktrm6')
!
!  Timing
!
  time1 = g_cpu_time()
