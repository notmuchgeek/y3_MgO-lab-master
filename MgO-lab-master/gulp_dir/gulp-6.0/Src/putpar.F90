...
!-----------------------
      ...
      if (nv.eq.1) then
        ...
        if (np.eq.1.or.np.eq.2.or.(np.ge.4.and.np.le.7).or.np.eq.8.or.np.eq.14.or.np.eq.17.or.np.eq.31.or.np.eq.58.or.np.eq.60) then
...
!
      ...
      elseif (nv.eq.2) then
        ...
        if (np.le.2.or.np.eq.5.or.np.eq.6.or.np.eq.14.or.np.eq.16.or.np.eq.28.or.np.eq.29.or.np.eq.58.or.np.eq.60) then
