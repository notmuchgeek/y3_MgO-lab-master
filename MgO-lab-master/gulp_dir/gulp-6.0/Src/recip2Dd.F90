                ...
                if (lrigid) then
                  if (latomicstress) then
                    do kk = 1,nstrains
                      ...
                      strderv(kk) = strderv(kk) - 0.5_dp*sineq*dGrds*kexperfc
...
!
                        sderv2(kk,ll) = sderv2(kk,ll) - 0.5_dp*sineq*strm1*(dg2ds(iv,kk)*dGrds2 + dg2ds(iv,ll)*dGrds1)
                        sderv2(kk,ll) = sderv2(kk,ll) - 0.5_dp*cosq*kexperfc*dGrds1*dGrds2
                        sderv2(kk,ll) = sderv2(kk,ll) - 0.5_dp*sineq*kexperfc*d2Grds12
                      endif
...
!
        ...
        call d2charge2D(i,j,nkvec,ix,iy,iz,jx,jy,jz,lopi,lopj,phsq,ktrm63, &
