...
!   9/19 ReaxFF charge arrays now a function of species
!
!  Conditions of use:
!
...
!  Species data
!
  call realloc_ch(5_i4,symbolreaxFFspec,maxreaxFFspec,ierror)
  ...
  call realloc(lreaxFFqfix,maxreaxFFspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxreaxFFspec','lreaxFFqfix')
  call realloc(lreaxFFunder,maxreaxFFspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxreaxFFspec','lreaxFFunder')
...
!  ReaxFF charge data
!
  call realloc(reaxFFchi,maxreaxFFspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxreaxFFspec','reaxFFchi')
  call realloc(reaxFFgamma,maxreaxFFspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxreaxFFspec','reaxFFgamma')
  call realloc(reaxFFmu,maxreaxFFspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxreaxFFspec','reaxFFmu')
  call realloc(reaxFFq0,maxreaxFFspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxreaxFFspec','reaxFFq0')
  call realloc(reaxFFqfix,maxreaxFFspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxreaxFFspec','reaxFFqfix')
  call realloc(reaxFFshell,3_i4,maxreaxFFspec,ierror)
  if (ierror.ne.0) call outofmemory('changemaxreaxFFspec','reaxFFshell')
!
