  subroutine real2a1fd(e12ap,e12ad,lgrad1,lgrad2)
!
...
!
  ...
  if (status/=0) call outofmemory('real2a1fd','npotl')
!
!  Set loop length
!
...
!
  ...
  if (status/=0) call deallocate_error('real2a1fd','npotl')
#ifdef TRACE
  call trace_out('real2a1fd')
#endif
!
  return
  end
