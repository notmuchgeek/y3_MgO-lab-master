...
!  Potential data
!
  call realloc(twopot,12_i4,maxpot,ierror)
  ...
  call realloc(lorder12,maxpot,ierror)
  if (ierror.ne.0) call outofmemory('changemaxpot','lorder12')
  call realloc(ipot,4_i4,maxpot,ierror)
  if (ierror.ne.0) call outofmemory('changemaxpot','ipot')
  ...
  call realloc(nspecptr1,maxpot,ierror)
  if (ierror.ne.0) call outofmemory('changemaxpot','nspecptr1')
  call realloc(nspecptr2,maxpot,ierror)
  if (ierror.ne.0) call outofmemory('changemaxpot','nspecptr2')
  ...
  call realloc_ch(5_i4,symbol2,2_i4,maxpot,ierror)
