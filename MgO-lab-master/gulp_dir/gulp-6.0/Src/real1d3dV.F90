  subroutine real1d3dV(nkp,i,j,nati,natj,d3s,d3rs,d3is,xji,yji,zji)
!
!  Subroutine for third derivatives of 1-D electrostatic energy
!  for i-j pair with respect to volume. Called from realrecip3d3dV. 
!
...
!
  ...
  real(dp),    intent(inout) :: d3is(3,3,3)
  real(dp),    intent(inout) :: d3rs(3,3,3)
