  subroutine projfork3ddV(nforkl,d34s,d34rs,dt11,dt21,dt31,dt22,dt32,dt33,gruen)
!
!  Calculates the frequency derivative contribution from the
!  third atom k to fourth atom l distance for the i-i dynamical 
!  matrix block (on diagonal) to the volume derivative.
!
!   1/18 Created from projfork3ds
!   2/18 Trace added
!
!  Conditions of use:
!
