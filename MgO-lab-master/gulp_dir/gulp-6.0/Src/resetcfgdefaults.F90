...
!
  ...
  ntempramp(nconfig) = 0
  ntempstp(1:maxtempramp,nconfig) = 0
  ntempstpstart(1:maxtempramp,nconfig) = 0
  ntran(nconfig) = 0
  ...
  straincfg(1:6,nconfig) = 0.0_dp
  stresscfg(1:6,nconfig) = 0.0_dp
  tempcfg(nconfig) = 0.0_dp
  tempstp(1:maxtempramp,nconfig) = 0.0_dp
