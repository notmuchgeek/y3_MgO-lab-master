  module m_pr
    ...
    real(dp),    dimension(:),   pointer, save :: pekin => null()
    real(dp),    dimension(:),   pointer, save :: taubcfg => null()
    real(dp),    dimension(:),   pointer, save :: tautcfg => null()
    real(dp),    dimension(:),   pointer, save :: pr_conscfg => null()
  end module m_pr
