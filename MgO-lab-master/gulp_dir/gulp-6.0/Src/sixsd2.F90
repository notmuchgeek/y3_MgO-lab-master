...
!
                          ...
                          esixl = esixl + eterm
!
!  Output energy contribution - factor of half included as per at the end of this routine
!
                          if (lPrintSix) then
...
!
                                do ivec = 1,15
                                  do kl = 1,nstrains
                                    kt = nstrptr(kl)
                                    sderv2(kl,kk) = sderv2(kl,kk) + 0.5_dp*dr2ds(kt,ivec)*temp(ivec)
                                    sderv2(kl,kk) = sderv2(kl,kk) + 0.5_dp*d2r2ds2(kt,ks,ivec)*e1d(ivec)
                                  enddo
                                enddo
!
!  Mixed derivatives
...
!
                                    derv3(ix,kk) = derv3(ix,kk) + d2r2dsdx(ks,1,indvec)*e1d(indvec)
                                    derv3(iy,kk) = derv3(iy,kk) + d2r2dsdx(ks,2,indvec)*e1d(indvec)
                                    derv3(iz,kk) = derv3(iz,kk) + d2r2dsdx(ks,3,indvec)*e1d(indvec)
                                  enddo
                                endif
                              enddo
                            endif
...
!
                                    derv3(ix,kk) = derv3(ix,kk) + d2r2dsdx(ks,1,2)*e1d(2)
                                    derv3(iy,kk) = derv3(iy,kk) + d2r2dsdx(ks,2,2)*e1d(2)
                                    derv3(iz,kk) = derv3(iz,kk) + d2r2dsdx(ks,3,2)*e1d(2)
!
...
!
                                    derv3(ix,kk) = derv3(ix,kk) + d2r2dsdx(ks,1,6)*e1d(6)
                                    derv3(iy,kk) = derv3(iy,kk) + d2r2dsdx(ks,2,6)*e1d(6)
                                    derv3(iz,kk) = derv3(iz,kk) + d2r2dsdx(ks,3,6)*e1d(6)
!
...
!
                                    derv3(ix,kk) = derv3(ix,kk) + d2r2dsdx(ks,1,10)*e1d(10)
                                    derv3(iy,kk) = derv3(iy,kk) + d2r2dsdx(ks,2,10)*e1d(10)
                                    derv3(iz,kk) = derv3(iz,kk) + d2r2dsdx(ks,3,10)*e1d(10)
!
...
!
                                    derv3(ix,kk) = derv3(ix,kk) + d2r2dsdx(ks,1,11)*e1d(11)
                                    derv3(iy,kk) = derv3(iy,kk) + d2r2dsdx(ks,2,11)*e1d(11)
                                    derv3(iz,kk) = derv3(iz,kk) + d2r2dsdx(ks,3,11)*e1d(11)
!
...
!
                                    derv3(ix,kk) = derv3(ix,kk) + d2r2dsdx(ks,1,12)*e1d(12)
                                    derv3(iy,kk) = derv3(iy,kk) + d2r2dsdx(ks,2,12)*e1d(12)
                                    derv3(iz,kk) = derv3(iz,kk) + d2r2dsdx(ks,3,12)*e1d(12)
                                  endif
                                enddo
                              endif
                            endif
