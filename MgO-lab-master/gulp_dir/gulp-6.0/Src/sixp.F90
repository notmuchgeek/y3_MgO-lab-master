...
!   1/17 Numbered loops replaced by loop labels
!   2/18 Trace added
!
!  Conditions of use:
!
...
!
                              if (ia.gt.ja) then
                                derv2dk(1:3,isxyz(1,ja),isxyz(1,ia)) = derv2dk(1:3,isxyz(1,ja),isxyz(1,ia)) - cdk(1:3)
                                derv2dk(1:3,isxyz(2,ja),isxyz(2,ia)) = derv2dk(1:3,isxyz(2,ja),isxyz(2,ia)) - cdk(1:3)
                                derv2dk(1:3,isxyz(3,ja),isxyz(3,ia)) = derv2dk(1:3,isxyz(3,ja),isxyz(3,ia)) - cdk(1:3)
                                derv2dk(1:3,isxyz(1,ia),isxyz(1,ja)) = derv2dk(1:3,isxyz(1,ia),isxyz(1,ja)) - conjg(cdk(1:3))
                                derv2dk(1:3,isxyz(2,ia),isxyz(2,ja)) = derv2dk(1:3,isxyz(2,ia),isxyz(2,ja)) - conjg(cdk(1:3))
                                derv2dk(1:3,isxyz(3,ia),isxyz(3,ja)) = derv2dk(1:3,isxyz(3,ia),isxyz(3,ja)) - conjg(cdk(1:3))
                              else
                                derv2dk(1:3,isxyz(1,ja),isxyz(1,ia)) = derv2dk(1:3,isxyz(1,ja),isxyz(1,ia)) - conjg(cdk(1:3))
                                derv2dk(1:3,isxyz(2,ja),isxyz(2,ia)) = derv2dk(1:3,isxyz(2,ja),isxyz(2,ia)) - conjg(cdk(1:3))
                                derv2dk(1:3,isxyz(3,ja),isxyz(3,ia)) = derv2dk(1:3,isxyz(3,ja),isxyz(3,ia)) - conjg(cdk(1:3))
                                derv2dk(1:3,isxyz(1,ia),isxyz(1,ja)) = derv2dk(1:3,isxyz(1,ia),isxyz(1,ja)) - cdk(1:3)
                                derv2dk(1:3,isxyz(2,ia),isxyz(2,ja)) = derv2dk(1:3,isxyz(2,ia),isxyz(2,ja)) - cdk(1:3)
                                derv2dk(1:3,isxyz(3,ia),isxyz(3,ja)) = derv2dk(1:3,isxyz(3,ia),isxyz(3,ja)) - cdk(1:3)
                              endif
                            endif
!
                            do jvec = ivec,15
...
!
                                    if (ia.gt.ib) then
                                      derv2dk(1:3,isxyz(ibet,ib),isxyz(ialp,ia)) = derv2dk(1:3,isxyz(ibet,ib),isxyz(ialp,ia)) +  &
                                          cdk(1:3)
                                    elseif (ia.lt.ib) then
                                      derv2dk(1:3,isxyz(ibet,ib),isxyz(ialp,ia)) = derv2dk(1:3,isxyz(ibet,ib),isxyz(ialp,ia)) +  &
                                          conjg(cdk(1:3))
...
!
                                    if (ia.gt.jb) then
                                      derv2dk(1:3,isxyz(ibet,jb),isxyz(ialp,ia)) = derv2dk(1:3,isxyz(ibet,jb),isxyz(ialp,ia)) -  &
                                          cdk(1:3)
                                    elseif (ia.lt.jb) then
                                      derv2dk(1:3,isxyz(ibet,jb),isxyz(ialp,ia)) = derv2dk(1:3,isxyz(ibet,jb),isxyz(ialp,ia)) -  &
                                          conjg(cdk(1:3))
...
!                                       
                                    if (ja.gt.jb) then
                                      derv2dk(1:3,isxyz(ibet,jb),isxyz(ialp,ja)) = derv2dk(1:3,isxyz(ibet,jb),isxyz(ialp,ja)) +  &
                                          cdk(1:3)
                                    elseif (ja.lt.jb) then
                                      derv2dk(1:3,isxyz(ibet,jb),isxyz(ialp,ja)) = derv2dk(1:3,isxyz(ibet,jb),isxyz(ialp,ja)) +  &
                                          conjg(cdk(1:3))
...
!                                       
                                    if (ja.gt.ib) then
                                      derv2dk(1:3,isxyz(ibet,ib),isxyz(ialp,ja)) = derv2dk(1:3,isxyz(ibet,ib),isxyz(ialp,ja)) -  &
                                          cdk(1:3)
                                    elseif (ja.lt.ib) then
                                      derv2dk(1:3,isxyz(ibet,ib),isxyz(ialp,ja)) = derv2dk(1:3,isxyz(ibet,ib),isxyz(ialp,ja)) -  &
                                          conjg(cdk(1:3))
...
!                                       
                                      if (ia.gt.ib) then
                                        derv2dk(1:3,isxyz(ialp,ia),isxyz(ibet,ib)) = derv2dk(1:3,isxyz(ialp,ia),isxyz(ibet,ib)) +  &
                                          conjg(cdk(1:3))
                                      elseif (ia.lt.ib) then
                                        derv2dk(1:3,isxyz(ialp,ia),isxyz(ibet,ib)) = derv2dk(1:3,isxyz(ialp,ia),isxyz(ibet,ib)) +  &
                                          cdk(1:3)
...
!
                                      if (ia.gt.jb) then
                                        derv2dk(1:3,isxyz(ialp,ia),isxyz(ibet,jb)) = derv2dk(1:3,isxyz(ialp,ia),isxyz(ibet,jb)) -  &
                                          conjg(cdk(1:3))
                                      elseif (ia.lt.jb) then
                                        derv2dk(1:3,isxyz(ialp,ia),isxyz(ibet,jb)) = derv2dk(1:3,isxyz(ialp,ia),isxyz(ibet,jb)) -  &
                                          cdk(1:3)
...
!
                                      if (ja.gt.jb) then
                                        derv2dk(1:3,isxyz(ialp,ja),isxyz(ibet,jb)) = derv2dk(1:3,isxyz(ialp,ja),isxyz(ibet,jb)) +  &
                                          conjg(cdk(1:3))
                                      elseif (ja.lt.jb) then
                                        derv2dk(1:3,isxyz(ialp,ja),isxyz(ibet,jb)) = derv2dk(1:3,isxyz(ialp,ja),isxyz(ibet,jb)) +  &
                                          cdk(1:3)
...
!
                                      if (ja.gt.ib) then
                                        derv2dk(1:3,isxyz(ialp,ja),isxyz(ibet,ib)) = derv2dk(1:3,isxyz(ialp,ja),isxyz(ibet,ib)) -  &
                                          conjg(cdk(1:3))
                                      elseif (ja.lt.ib) then
                                        derv2dk(1:3,isxyz(ialp,ja),isxyz(ibet,ib)) = derv2dk(1:3,isxyz(ialp,ja),isxyz(ibet,ib)) -  &
                                          cdk(1:3)
