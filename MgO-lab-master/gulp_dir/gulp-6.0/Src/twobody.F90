  subroutine twobody(eatom,ereal,ec6,lgrad1,lgrad2,lgrad3,nor,nor0,npots,npotl, &
                     cut2r,cut2e,cut2s,nmolonly,factor,sfct,spfct,radsum, &
...
!  Bulk electrostatics
!
          if ((r2.le.cut2e.or.lptrmol(k)).and.(lewald.or.lwolf).and.(abs(factor).gt.1.0d-12.or.lpolar)) then
...
!
  call twobody(eatom,ereal,ec6,lgrad1,lgrad2,lgrad3,nor,nor0,npots,npotl,cut2r,cut2e,cut2s,nmolonly, &
               factor,sfct,spfct,radsum,sctrm1,sctrm2,qi,qj,lcspair,lperiodic,lregion1,lskipsr, &
               lskipq)
!
