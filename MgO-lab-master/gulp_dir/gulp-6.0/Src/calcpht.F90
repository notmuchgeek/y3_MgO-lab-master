...
!
    if (nREBOsi.ne.1) then
#ifdef TRACE
      call trace_out('calcP')
#endif
      return
    endif
!
...
!
  if (.not.Fneeded(nREBObo)) then
#ifdef TRACE
    call trace_out('calcF')
#endif
    return
  endif
!
