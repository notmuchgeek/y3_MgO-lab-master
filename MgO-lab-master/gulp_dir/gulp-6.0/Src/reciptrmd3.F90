...
!   2/18 Trace added
!   2/18 Correction to 3-D derivatives for strain 4
...
!
        ...
        d3rs(3,2,4) = d3rs(3,2,4) + coss*tmp4*tmp4 + 0.5_dp*cosq*(tmp2 + tmp3)
        ...
        d3rs(3,1,5) = d3rs(3,1,5) + coss*tmp5*tmp5 + 0.5_dp*cosq*(tmp1 + tmp3)
        ...
        d3rs(2,1,6) = d3rs(2,1,6) + coss*tmp6*tmp6 + 0.5_dp*cosq*(tmp1 + tmp2)
...
!
        ...
        d3is(2,2,4) = d3is(2,2,4) - sins*tmp2*tmp4 - sinq*tmp4
