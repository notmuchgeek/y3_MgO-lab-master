  subroutine recip12a(erecip,ec6,lgrad1,lgrad2,imode)
!
...
!   5/17 Parallelised for imode = 2 with no derivatives
!   2/18 Trace added
...
!
!  Globalise energy for imode = 2 with no derivatives
!
  if (imode.eq.2.and..not.lgrad1) then
    esum1(1) = erecip
    esum1(2) = ec6
    call sumall(esum1,esum2,2_i4,"recip12a","esum")
    erecip = esum2(1)
    ec6    = esum2(2)
  endif
!
