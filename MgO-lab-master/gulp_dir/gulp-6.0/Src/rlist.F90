    ...
    do ii = -1,1
      ...
      do jj = -1,1
        ...
        do kk = -1,1
          ...
          ycrd = ycrd + r3y
          zcrd = zcrd + r3z
          ivec1cell(1,iimax) = ii
          ivec1cell(2,iimax) = jj
          ivec1cell(3,iimax) = kk
