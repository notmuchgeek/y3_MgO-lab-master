  subroutine qeqbody(eqeq,lgrad1,lgrad2,nor,nor0,factor,qli,qlj,nati,natj,nqri,nqrj)
!
...
!***************************************
  zetai = 0.5_dp*qeqlambda*(2*npqni+1)/radrange(nqri,nati,neemtype)
  zetaj = 0.5_dp*qeqlambda*(2*npqnj+1)/radrange(nqrj,natj,neemtype)
...
!  Wrapper for qeqbody
!*********************************************************************
  subroutine qeqbody1(eqeq,lgrad1,lgrad2,nor,nor0,dist1,deriv1,deriv21, &
...
!  Call qeqbody
!
  call qeqbody(eqeq,lgrad1,lgrad2,nor,nor0,factor,qli,qlj,nati,natj,nqri,nqrj)
!
