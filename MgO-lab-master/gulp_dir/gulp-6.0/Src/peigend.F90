...
!
          ...
          ii = 0
          do i = 1,nphonatc
            write(53,'(3f10.6,4x,3f10.6)') (real(etmp(ii+j,1)),j=1,3),(cmplx(etmp(ii+k,1)),k=1,3)
            ii = ii + 3
          enddo
          if (lrigid) then
            do i = 1,nphonatm
        ...
        if (mm.gt.0) then
          ...
          ii = 0
          do i = 1,nphonatc
            write(53,'(3f10.6,4x,3f10.6)') (real(eigc(ii+j,mm)),j=1,3),(cmplx(eigc(ii+k,mm)),k=1,3)
            ii = ii + 3
          enddo
          if (lrigid) then
            do i = 1,nphonatm
...
!
        ...
        if (mm.gt.0) then
          ...
          do i = 1,nphonatc
            ig = ig + 1
            write(54,'(2i5,2f16.12,4x,2f16.12,4x,2f16.12)') m,ig, &
              eigc(ii+1,mm),eigc(ii+2,mm),eigc(ii+3,mm)
            ii = ii + 3
          enddo
          if (lrigid) then
            do i = 1,nphonatm
...
!
          ...
          if (mtvrptr(indi+1).gt.0) then
            indj = 0
            do j = 1,njloop
              write(ioout,'(i6,'' x '',4x,6f10.6)') j,(eigc(indj+1,mtvrptr(indi+k)),k=1,3)
              write(ioout,'(i6,'' y '',4x,6f10.6)') j,(eigc(indj+2,mtvrptr(indi+k)),k=1,3)
              write(ioout,'(i6,'' z '',4x,6f10.6)') j,(eigc(indj+3,mtvrptr(indi+k)),k=1,3)
              indj = indj + 3
            enddo
            if (lrigid) then
              do j = 1,nphonatm
                write(ioout,'(i6,'' Tx'',4x,6f10.6)') j,(eigc(indj+1,mtvrptr(indi+k)),k=1,3)
                write(ioout,'(i6,'' Ty'',4x,6f10.6)') j,(eigc(indj+2,mtvrptr(indi+k)),k=1,3)
                write(ioout,'(i6,'' Tz'',4x,6f10.6)') j,(eigc(indj+3,mtvrptr(indi+k)),k=1,3)
                write(ioout,'(i6,'' R1'',4x,6f10.6)') j,(eigc(indj+4,mtvrptr(indi+k)),k=1,3)
                write(ioout,'(i6,'' R2'',4x,6f10.6)') j,(eigc(indj+5,mtvrptr(indi+k)),k=1,3)
                write(ioout,'(i6,'' R3'',4x,6f10.6)') j,(eigc(indj+6,mtvrptr(indi+k)),k=1,3)
                indj = indj + 6
              enddo
            endif
          endif
...
!
        ...
        if (mtvrptr(indi+1).gt.0) then
          indj = 0
          do j = 1,njloop
            write(ioout,'(i6,'' x '',4x,6f10.6)') j,(eigc(indj+1,mtvrptr(indi+k)),k=1,iresid)
            write(ioout,'(i6,'' y '',4x,6f10.6)') j,(eigc(indj+2,mtvrptr(indi+k)),k=1,iresid)
            write(ioout,'(i6,'' z '',4x,6f10.6)') j,(eigc(indj+3,mtvrptr(indi+k)),k=1,iresid)
            indj = indj + 3
          enddo
          if (lrigid) then
            do j = 1,nphonatm
              write(ioout,'(i6,'' Tx'',4x,6f10.6)') j,(eigc(indj+1,mtvrptr(indi+k)),k=1,iresid)
              write(ioout,'(i6,'' Ty'',4x,6f10.6)') j,(eigc(indj+2,mtvrptr(indi+k)),k=1,iresid)
              write(ioout,'(i6,'' Tz'',4x,6f10.6)') j,(eigc(indj+3,mtvrptr(indi+k)),k=1,iresid)
              write(ioout,'(i6,'' R1'',4x,6f10.6)') j,(eigc(indj+4,mtvrptr(indi+k)),k=1,iresid)
              write(ioout,'(i6,'' R2'',4x,6f10.6)') j,(eigc(indj+5,mtvrptr(indi+k)),k=1,iresid)
              write(ioout,'(i6,'' R3'',4x,6f10.6)') j,(eigc(indj+6,mtvrptr(indi+k)),k=1,iresid)
              indj = indj + 6
            enddo
          endif
        endif
