...
!
!  Julian Gale, CIC, Curtin University, 2010
...
!****************************************************************************!
  ...
  subroutine outpdf()
    ...
    character(len=maxwordlength)  :: parstring ! string of partial details
    character(len=5)              :: parname ! partial name
    character(len=maxwordlength)  :: root ! file root
...
!
!  Calls the following principal routines:
...
!****************************************************************************!
  function pdfwidthsq(i_atom,j_atom,lvec,R_ij,wminsofar,wmaxsofar)
    ...
    use g_constants, only : hbar_js !planks constant in Js
