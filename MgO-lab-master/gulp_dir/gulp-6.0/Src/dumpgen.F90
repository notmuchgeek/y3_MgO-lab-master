...
!
  ...
  use maths,              only : lcosmo2D, lhess2D
  use moldyn
  use molecule
  use montecarlo
  use g_neb
...
!
            if (lfit) then
              ...
              elseif (nqrtyp.eq.1) then
                ...
                write(iout,'(a2,4(1x,f10.5),1x,f8.5,1x,f9.5,4i2)') &
                  atsym(i),chirange(nqr,i,ieem),murange(nqr,i,ieem), &
                  zetarange(nqr,i,ieem),znucrange(nqr,i,ieem),q0range(nqr,i,ieem), &
              ...
              if (nqrtyp.eq.3) then
                write(iout,'(a2,4(1x,f10.5),1x,f8.5,'' &'')') &
                  atsym(i),chirange(nqr,i,ieem),murange(nqr,i,ieem), &
                  zetarange(nqr,i,ieem),znucrange(nqr,i,ieem),q0range(nqr,i,ieem)
                write(iout,'(2x,f9.5,1x,f8.5,1x,f8.4)') &
                  e0range(nqr,i,ieem),qrangemin(nqr,i,ieem),qrangemax(nqr,i,ieem)
              elseif (nqrtyp.eq.2) then
                write(iout,'(a2,4(1x,f10.5),1x,f8.5,'' &'')') &
                  atsym(i),chirange(nqr,i,ieem),murange(nqr,i,ieem), &
                  zetarange(nqr,i,ieem),znucrange(nqr,i,ieem),q0range(nqr,i,ieem)
                write(iout,'(2x,f9.5,1x,f8.4)') &
              ...
              elseif (nqrtyp.eq.1) then
                ...
                write(iout,'(a2,4(1x,f10.5),1x,f8.5,1x,f9.5)') &
                  atsym(i),chirange(nqr,i,ieem),murange(nqr,i,ieem), &
                  zetarange(nqr,i,ieem),znucrange(nqr,i,ieem),q0range(nqr,i,ieem), &
                  e0range(nqr,i,ieem)
              endif
