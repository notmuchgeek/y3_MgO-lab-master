...
!
                    ...
                    if (lrigid) then
                      ...
                      if (i.ne.j) then
                        derv3(jx,kk) = derv3(jx,kk) - xrkk*d3kk - (cosq-cos6)*xrkk*dGrds1 - sineq*( &
                          xrkk*d2rxyzdsdx(kk,1,1) + dgds(iv,1,kk) + yrkk*d2rxyzdsdx(kk,2,1) + zrkk*d2rxyzdsdx(kk,3,1))
                        derv3(jy,kk) = derv3(jy,kk) - yrkk*d3kk - (cosq-cos6)*yrkk*dGrds1 - sineq*( &
                          xrkk*d2rxyzdsdx(kk,1,2) + yrkk*d2rxyzdsdx(kk,2,2) + dgds(iv,2,kk) + zrkk*d2rxyzdsdx(kk,3,2))
                        derv3(jz,kk) = derv3(jz,kk) - zrkk*d3kk - (cosq-cos6)*zrkk*dGrds1 - sineq*( &
                          xrkk*d2rxyzdsdx(kk,1,3) + yrkk*d2rxyzdsdx(kk,2,3) + zrkk*d2rxyzdsdx(kk,3,3) + dgds(iv,3,kk))
                      endif
                    else
                      if (lopi) then
                  ...
                  do kk = 1,6
                    ...
                    do ll = kk,6
                      if (lrigid) then
                        dGrds2 = xrkk*drxyzds(ll,1) + yrkk*drxyzds(ll,2) + zrkk*drxyzds(ll,3) + &
                                 xd*dgds(iv,1,ll) + yd*dgds(iv,2,ll) + zd*dgds(iv,3,ll)
                        sderv2(ll,kk) = sderv2(ll,kk) - (cosq*dGrds1*dGrds2 + sineq*( &
                                                        xrkk*d2rxyzds2(ll,kk,1) + xd*d2gds2(iv,1,ll,kk) + &
                                                        yrkk*d2rxyzds2(ll,kk,2) + yd*d2gds2(iv,2,ll,kk) + &
                                                        zrkk*d2rxyzds2(ll,kk,3) + zd*d2gds2(iv,3,ll,kk) + &
                                                        dgds(iv,1,ll)*drxyzds(kk,1) + dgds(iv,1,kk)*drxyzds(ll,1) + &
...
!
                    ...
                    if (lrigid) then
                      ...
                      derv3(iz,kk) = derv3(iz,kk) + zrkk*d3kk + cosq*zrkk*dGrds1 + sineq*( &
                        xrkk*d2rxyzdsdx(kk,1,3) + yrkk*d2rxyzdsdx(kk,2,3) + zrkk*d2rxyzdsdx(kk,3,3) + dgds(iv,3,kk))
                      if (i.ne.j) then
                        derv3(jx,kk) = derv3(jx,kk) - xrkk*d3kk - cosq*xrkk*dGrds1 - sineq*( &
                          xrkk*d2rxyzdsdx(kk,1,1) + dgds(iv,1,kk) + yrkk*d2rxyzdsdx(kk,2,1) + zrkk*d2rxyzdsdx(kk,3,1))
                        derv3(jy,kk) = derv3(jy,kk) - yrkk*d3kk - cosq*yrkk*dGrds1 - sineq*( &
                          xrkk*d2rxyzdsdx(kk,1,2) + yrkk*d2rxyzdsdx(kk,2,2) + dgds(iv,2,kk) + zrkk*d2rxyzdsdx(kk,3,2))
                        derv3(jz,kk) = derv3(jz,kk) - zrkk*d3kk - cosq*zrkk*dGrds1 - sineq*( &
                          xrkk*d2rxyzdsdx(kk,1,3) + yrkk*d2rxyzdsdx(kk,2,3) + zrkk*d2rxyzdsdx(kk,3,3) + dgds(iv,3,kk))
                      endif
                    else
                      if (lopi) then
...
!
    ...
    if (lgrad2) then
      ...
      nff = 0
      do i = 1,numat
        if (.not.lfreeze.or.lopf(nrelf2a(i))) then
          nff = nff + 1
          ix = ix + 3
          iy = iy + 3
          iz = iz + 3
          ...
          jz =   0
          do j = 1,i
            if (.not.lfreeze.or.lopf(nrelf2a(j))) then
              jx = jx + 3
              jy = jy + 3
              jz = jz + 3
