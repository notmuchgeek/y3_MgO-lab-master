...
!
  ...
  if (iseed.lt.0) then
    ...
    do i = 1,97
      ...
      rr(i) = (dble(ix1) + dble(ix2)*rm2)*rm1
    enddo
    iseed = abs(iseed)
  endif
  ...
  ix1 = mod(ia1*ix1 + ic1,m1)
  ix2 = mod(ia2*ix2 + ic2,m2)
  rr(j) = (dble(ix1) + dble(ix2)*rm2)*rm1
!
...
!
!  NB: Correction made as stdev was not being used
!
