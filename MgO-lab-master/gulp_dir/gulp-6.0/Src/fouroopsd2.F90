...
!   5/15 Corrections to derv2 made as referencing of elements was incorrect
...
!
                    if (lasu1) then
                      do kl = 1,nstrains
                        ks = nstrptr(kl)
                        rstrd(kl) = rstrd(kl) + e1d(1)*dr2ds(ks,1)*dble(neqi)
                        rstrd(kl) = rstrd(kl) + e1d(2)*dr2ds(ks,2)*dble(neqi)
                        rstrd(kl) = rstrd(kl) + e1d(3)*dr2ds(ks,3)*dble(neqi)
                        rstrd(kl) = rstrd(kl) + e1d(4)*dr2ds(ks,4)*dble(neqi)
                        rstrd(kl) = rstrd(kl) + e1d(5)*dr2ds(ks,5)*dble(neqi)
                        rstrd(kl) = rstrd(kl) + e1d(6)*dr2ds(ks,6)*dble(neqi)
                      enddo
                    endif
!
...
!
                        if (lasu1) then
                          do kl = 1,nstrains
                            kt = nstrptr(kl)
                            sderv2(kl,kk) = sderv2(kl,kk) + dr2ds(kt,1)*temp(1)*dble(neqi)
                            sderv2(kl,kk) = sderv2(kl,kk) + dr2ds(kt,2)*temp(2)*dble(neqi)
                            sderv2(kl,kk) = sderv2(kl,kk) + dr2ds(kt,3)*temp(3)*dble(neqi)
                            sderv2(kl,kk) = sderv2(kl,kk) + dr2ds(kt,4)*temp(4)*dble(neqi)
                            sderv2(kl,kk) = sderv2(kl,kk) + dr2ds(kt,5)*temp(5)*dble(neqi)
                            sderv2(kl,kk) = sderv2(kl,kk) + dr2ds(kt,6)*temp(6)*dble(neqi)
!
                            sderv2(kl,kk) = sderv2(kl,kk) + d2r2ds2(kt,ks,1)*e1d(1)*dble(neqi)
                            sderv2(kl,kk) = sderv2(kl,kk) + d2r2ds2(kt,ks,2)*e1d(2)*dble(neqi)
                            sderv2(kl,kk) = sderv2(kl,kk) + d2r2ds2(kt,ks,3)*e1d(3)*dble(neqi)
                            sderv2(kl,kk) = sderv2(kl,kk) + d2r2ds2(kt,ks,4)*e1d(4)*dble(neqi)
                            sderv2(kl,kk) = sderv2(kl,kk) + d2r2ds2(kt,ks,5)*e1d(5)*dble(neqi)
                            sderv2(kl,kk) = sderv2(kl,kk) + d2r2ds2(kt,ks,6)*e1d(6)*dble(neqi)
                          enddo
!
!  Mixed derivatives
!
...
!
                        ...
                        if (lasu2.and.lopj) then
                          if (lopi) then
                            derv2(n12,n21a) = derv2(n12,n21a) + t12*dble(neqj)
                          else
                            derv2(n22,n21a) = derv2(n22,n21a) + t12*dble(neqj)
                          endif
                          if (lopk) then
                        ...
                        if (lasu3.and.lopk) then
                          if (lopi) then
                            derv2(n12,n31a) = derv2(n12,n31a) + t13*dble(neqk)
                          else
                            derv2(n32,n31a) = derv2(n32,n31a) + t13*dble(neqk)
                          endif 
                          if (lopj) then
                        ...
                        if (lasu4.and.lopl) then
                          if (lopi) then
                            derv2(n12,n41a) = derv2(n12,n41a) + t14*dble(neql)
                          else
                            derv2(n42,n41a) = derv2(n42,n41a) + t14*dble(neql)
                          endif 
                          if (lopj) then
