  subroutine fenergy3(fc,lgrad1,hessian,nhwords,lhess2D,lkeepd2)
!
...
!   4/17 mcv4 added to call to setquasiharm for parallel compatibility
!   1/18 Trace added
...
!
    ...
    call setquasiharm(dsqh,3_i4*ncsfoc,3_i4*ncsfoc,4_i4)
  endif
!***********************
!  Loop over k points  *
!***********************
...
!  and resymmetrise
!
      call phoncopy2e(0_i4,derv2,dervi,cmat,maxd2,mcv,mcv,msv,msv)
!***********************************************
...
!************************************
    ifail = 0
    call diagdyn(k,mcv,maxd2,mcvmin,freq(1,k-nlkpt+1),fscale,cmat(1),cmat(maxd2*maxd2+1),ifail)
...
!
      call scaleevec(mcv,mcv,cmat(1),maxd2,dfdw2)
      call scaleevec(mcv,mcv,cmat(maxd2*maxd2+1),maxd2,dfdw2)
!
...
!  Debugging output  *
!*********************
      if (index(keyword,'dyna').ne.0.and.msv.gt.0.and.ioproc) then
