...
!   3/15 Number of 3-body fitting flags now allows for 16 in main array
!   8/15 Garofalini form of sw3 added
!   7/17 Angle multiply by radtodeg removed since this is no longer needed
!   7/17 Option added to force dumping of generated potentials
!   2/18 Trace added
...
!*************************
  if (nthbo.gt.0) then
    allocate(itmp(16*nthbo),stat=status)
...
!
      if (lgenerated3(i).and..not.ldumpgenerated) cycle loop3body
!
      the = theta(i)
!
...
!
        ...
        if (mmtexc(i).eq.1) then
          if (thrho1(i).ne.0.0_dp.and.thrho2(i).ne.0.0_dp) then
            if (lfit) then
              ...
              write(iout,'(3(a5,1x,a4,1x),3(g11.4,1x),''&'')')lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i), &
                thrho2(i),thrho1(i)
              write(iout,'(g11.4,1x,4i2)')the,itmp(16*(i-1)+1),itmp(16*(i-1)+3),itmp(16*(i-1)+4),itmp(16*(i-1)+2)
            else
              write(iout,'(''three k3 k4 bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),3(g11.4,1x),''&'')')lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i), &
                thrho2(i),thrho1(i)
          ...
          elseif (thrho2(i).ne.0.0_dp) then
            if (lfit) then
              ...
              write(iout,'(3(a5,1x,a4,1x),3(g11.4,1x),3i2)') lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i), &
                thrho2(i),the,itmp(16*(i-1)+1),itmp(16*(i-1)+3),itmp(16*(i-1)+2)
            else
              write(iout,'(''three k3 bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          ...
          elseif (thrho1(i).ne.0.0_dp) then
            if (lfit) then
              ...
              write(iout,'(3(a5,1x,a4,1x),3(g11.4,1x),3i2)') lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i), &
                thrho1(i),the,itmp(16*(i-1)+1),itmp(16*(i-1)+4),itmp(16*(i-1)+2)
            else
              write(iout,'(''three k4 bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            ...
            if (lfit) then
              ...
              write(iout,'(3(a5,1x,a4,1x),g10.5,1x,g10.5,2i2)') &
                lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,itmp(16*(i-1)+1),itmp(16*(i-1)+2)
            else
              write(iout,'(''three bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          ...
          if (thrho1(i).ne.0.0_dp.and.thrho2(i).ne.0.0_dp) then
            if (lfit) then
              ...
              write(iout,'(g11.4,1x,6(1x,f8.4),4i2)') the,thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i), &
                thr3(i),itmp(16*(i-1)+1),itmp(16*(i-1)+3),itmp(16*(i-1)+4),itmp(16*(i-1)+2)
            else
              write(iout,'(''three k3 k4 '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),3(g11.4,1x),''&'')') &
                  lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho2(i),thrho1(i)
          ...
          elseif (thrho2(i).ne.0.0_dp) then
            if (lfit) then
              ...
              write(iout,'(6(1x,f6.3),3i2)') &
                ...
                thr3(i),itmp(16*(i-1)+1),itmp(16*(i-1)+3),itmp(16*(i-1)+2)
            else
              write(iout,'(''three k3 '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),3(g11.4,1x),''&'')') &
                lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho2(i),the
          ...
          elseif (thrho1(i).ne.0.0_dp) then
            if (lfit) then
              ...
              write(iout,'(6(1x,f6.3),3i2)') &
                thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i), &
                thr3(i),itmp(16*(i-1)+1),itmp(16*(i-1)+4),itmp(16*(i-1)+2)
            else
              write(iout,'(''three k4 '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),3(g11.4,1x),'' &'')') &
                lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho1(i),the
            ...
            if (lfit) then
              ...
              write(iout,'(6(1x,f6.3),2i2)')thr1min(i),thr1(i), &
                thr2min(i),thr2(i),thr3min(i),thr3(i),itmp(16*(i-1)+1),itmp(16*(i-1)+2)
            else
              write(iout,'(''three '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
      ...
      elseif (nthrty(i).eq.2.or.nthrty(i).eq.8) then
        ...
        if (mmtexc(i).eq.1) then
          if (lfit) then
            ...
            write(iout,'(4i2)') itmp(16*(i-1)+1),itmp(16*(i-1)+2),itmp(16*(i-1)+3),itmp(16*(i-1)+4)
          else
            if (nthrty(i).eq.2) then
              write(iout,'(''three exponential bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            else
          ...
          if (lfit) then
            ...
            write(iout,'(6(1x,f8.3),4i2)')thr1min(i),thr1(i), &
              thr2min(i),thr2(i),thr3min(i),thr3(i),(itmp(16*(i-1)+j),j=1,4)
          else
            if (nthrty(i).eq.2) then
              write(iout,'(''three exponential '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            else
        ...
        if (mmtexc(i).eq.1) then
          ...
          if (lfit) then
            write(iout,'(3(a5,1x,a4,1x),g14.6,i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),itmp(16*(i-1)+1)
          else
          ...
          if (lfit) then
            write(iout,'(4(1x,f8.3),i2)') thr2min(i),thr2(i),thr3min(i),thr3(i),itmp(16*(i-1)+1)
          else
        ...
        if (mmtexc(i).eq.1) then
          ...
          if (lfit) then
            write(iout,'(3(a5,1x,a4,1x),g14.6,3(1x,f8.6),4i2)') &
              ...
              ctmp(3),thbk(i),theta(i),thrho1(i),thrho2(i),(itmp(16*(i-1)+j),j=1,4)
          else
          ...
          if (lfit) then
            write(iout,'(6(1x,f8.3),4i2)') &
              thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i),(itmp(16*(i-1)+j),j=1,4)
          else
      ...
      elseif (nthrty(i).eq.5) then
        if (abs(thrho3(i)).gt.0.0_dp) then
          write(iout,'(''sw3 modified '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g14.6,1x,f8.4,2(1x,f8.6),'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,thrho1(i),thrho2(i)
          if (lfit) then
            write(iout,'(f12.6,6(1x,f8.3),5i2)') &
              thrho3(i),thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i),(itmp(16*(i-1)+j),j=1,5)
          else
            write(iout,'(f12.6,6(1x,f8.3))') thrho3(i),thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i)
          endif
        else
        ...
        if (mmtexc(i).eq.1) then
          ...
          if (lfit) then
            write(iout,'(3(a5,1x,a3,1x),g11.5,1x,2(1x,f8.6),3i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),rho1,rho2,itmp(16*(i-1)+1), &
              itmp(16*(i-1)+3),itmp(16*(i-1)+4)
          else
          ...
          if (lfit) then
            write(iout,'(6(1x,f8.3),3i2)') thr1min(i),thr1(i), &
              thr2min(i),thr2(i),thr3min(i),thr3(i),itmp(16*(i-1)+1),itmp(16*(i-1)+3),itmp(16*(i-1)+4)
          else
            write(iout,'(6(1x,f8.3))') thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i)
          endif
        endif
        ...
        if (mmtexc(i).eq.1) then
          ...
          if (lfit) then
            write(iout,'(3(a5,1x,a3,1x),g11.5,1x,f8.6,2i2)') lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3), &
              thbk(i),theta(i),itmp(16*(i-1)+1),itmp(16*(i-1)+2)
          else
      ...
      elseif (nthrty(i).eq.9) then
        if (mmtexc(i).eq.1) then
          if (thrho1(i).ne.0.0_dp.and.thrho2(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three cosine k3 k4 bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho2(i)
              write(iout,'(2(g15.8,1x),4i2)') thrho1(i),the,itmp(16*(i-1)+1),itmp(16*(i-1)+3),itmp(16*(i-1)+4),itmp(16*(i-1)+2)
            else
              write(iout,'(''three cosine k3 k4 bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho2(i)
              write(iout,'(2(g15.8,1x))') thrho1(i),the
            endif
          elseif (thrho2(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three cosine k3 bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho2(i)
              write(iout,'(g15.8,1x,3i2)') the,itmp(16*(i-1)+1),itmp(16*(i-1)+3),itmp(16*(i-1)+2)
            else
              write(iout,'(''three cosine k3 bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho2(i)
              write(iout,'(g15.8,1x)') the
            endif
          elseif (thrho1(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three cosine k4 bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho1(i)
              write(iout,'(g15.8,1x,3i2)') the,itmp(16*(i-1)+1),itmp(16*(i-1)+4),itmp(16*(i-1)+2)
            else
              write(iout,'(''three cosine k4 bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho1(i)
              write(iout,'(g15.8,1x)') the
            ...
            if (lfit) then
              ...
              write(iout,'(3(a5,1x,a4,1x),g15.8,1x,g15.8,2i2)') &
                lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,itmp(16*(i-1)+1),itmp(16*(i-1)+2)
            else
              write(iout,'(''three bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),g15.8,1x,g15.8)') lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the
            endif
          endif
        else
          if (thrho1(i).ne.0.0_dp.and.thrho2(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three cosine k3 k4 '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') &
                lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho2(i)
              write(iout,'(2(g15.8,1x),''&'')') thrho1(i),the
              write(iout,'(6(1x,f8.4),4i2)') thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i), &
                thr3(i),itmp(16*(i-1)+1),itmp(16*(i-1)+3),itmp(16*(i-1)+4),itmp(16*(i-1)+2)
            else
              write(iout,'(''three cosine k3 k4 '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') &
                lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho2(i)
              write(iout,'(2(g15.8,1x),''&'')') thrho1(i),the
              write(iout,'(6(1x,f8.4))') thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i)
            endif
          elseif (thrho2(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three cosine k3 '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') &
                lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho2(i)
              write(iout,'(g15.8,1x,6(1x,f8.4),3i2)') the,thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i), &
                thr3(i),itmp(16*(i-1)+1),itmp(16*(i-1)+3),itmp(16*(i-1)+2)
            else
              write(iout,'(''three cosine k3 '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') &
                lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho2(i)
              write(iout,'(g15.8,1x,6(1x,f8.4))') the,thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i), &
                thr3(i)
            endif
          elseif (thrho1(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three cosine k4 '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') &
                lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho1(i)
              write(iout,'(g15.8,1x,6(1x,f8.4),3i2)') the,thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i), &
                thr3(i),itmp(16*(i-1)+1),itmp(16*(i-1)+4),itmp(16*(i-1)+2)
            else
              write(iout,'(''three cosine k4 '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            ...
            if (lfit) then
              ...
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') &
                lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the
              write(iout,'(6(1x,f8.4),2i2)') thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i), &
                thr3(i),itmp(16*(i-1)+1),itmp(16*(i-1)+2)
            else
              write(iout,'(''three cosine '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') &
                lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the
      ...
      elseif (nthrty(i).eq.10) then
        if (mmtexc(i).eq.1) then
          ...
          write(iout,'(3(a5,1x,a4,1x),g14.6,1x,f8.5,'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),theta(i)
          if (lfit) then
            write(iout,'(3(1x,f8.6),5i2)')thrho1(i),thrho2(i),thrho3(i),(itmp(16*(i-1)+j),j=1,5)
          else
          ...
          if (lfit) then
            write(iout,'(3(1x,f8.6),6(1x,f6.3),5i2)')thrho1(i), &
              ...
              thr2(i),thr3min(i),thr3(i),(itmp(16*(i-1)+j),j=1,5)
          else
      ...
      elseif (nthrty(i).eq.11) then
        if (mmtexc(i).eq.1) then
          ...
          if (lfit) then
            write(iout,'(2(1x,f8.6),1x,f8.4,5i2)')thrho1(i),thrho2(i),the,(itmp(16*(i-1)+j),j=1,5)
          else
        ...
        if (mmtexc(i).eq.1) then
          ...
          if (lfit) then
            write(iout,'(3(a5,1x,a4,1x),g14.6,1x,f8.5,2(1x,i2))') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i), &
              theta(i),nint(thrho1(i)),itmp(16*(i-1)+1)
          else
          ...
          write(iout,'(3(a5,1x,a4,1x),g14.6,1x,f8.5,1x,i2,'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),theta(i),nint(thrho1(i))
          if (lfit) then
            write(iout,'(6(1x,f8.3),i2)')thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i),itmp(16*(i-1)+1)
          else
            write(iout,'(6(1x,f8.3))')thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i)
          endif
        endif
        ...
        if (mmtexc(i).eq.1) then
          ...
          if (lfit) then
            write(iout,'(3(a5,1x,a3,1x),g11.5,1x,f8.5,1x,i1,1x,i2,2(1x,f8.6),4i2)') &
              ...
              rho1,rho2,itmp(16*(i-1)+1),itmp(16*(i-1)+2),itmp(16*(i-1)+3),itmp(16*(i-1)+4)
          else
          ...
          if (lfit) then
            write(iout,'(6(1x,f8.3),3i2)')thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i), &
              itmp(16*(i-1)+1),itmp(16*(i-1)+2),itmp(16*(i-1)+3),itmp(16*(i-1)+4)
          else
            write(iout,'(6(1x,f8.3))')thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i)
          endif
        endif
      ...
      elseif (nthrty(i).eq.15) then
        ...
        if (lfit) then
          write(iout,'(6(1x,f8.3),2i2)')  &
            thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i),(itmp(16*(i-1)+j),j=1,2)
        else
      ...
      elseif (nthrty(i).eq.16) then
        ...
        if (mmtexc(i).eq.1) then
          if (lfit) then
            ...
            write(iout,'(3(a5,1x,a3,1x),g17.6,1x,f8.4,2(1x,f8.6),'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,rho1,rho2
            write(iout,'(3i2)') itmp(16*(i-1)+1),itmp(16*(i-1)+3),itmp(16*(i-1)+4)
          else
            write(iout,'(''equatorial bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            write(iout,'(3(a5,1x,a3,1x),g17.6,1x,f8.4,2(1x,f8.6))') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,rho1,rho2
          ...
          if (lfit) then
            ...
            write(iout,'(3(a5,1x,a3,1x),g17.6,1x,f8.4,2(1x,f8.6),'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,rho1,rho2
            write(iout,'(6(1x,f8.3),3i2)') thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i), &
              itmp(16*(i-1)+1),itmp(16*(i-1)+3),itmp(16*(i-1)+4)
          else
            write(iout,'(''equatorial '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            write(iout,'(3(a5,1x,a3,1x),g17.6,1x,f8.4,2(1x,f8.6),'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,rho1,rho2
      ...
      elseif (nthrty(i).eq.20) then
        if (mmtexc(i).eq.1) then
          ...
          if (lfit) then
            write(iout,'(2(1x,f8.6),1x,5i2)') thrho2(i),thrho3(i),(itmp(16*(i-1)+j),j=1,5)
          else
      ...
      elseif (nthrty(i).eq.22) then
        if (mmtexc(i).eq.1) then
          ...
          if (lfit) then
            write(iout,'(1x,f8.4,1x,3i3,1x,4i2)') the,(nint(threepoly(k,i)),k=1,3),(itmp(16*(i-1)+j),j=1,4)
          else
      ...
      elseif (nthrty(i).eq.23) then
        if (mmtexc(i).eq.1) then
          ...
          write(iout,'(3(a5,1x,a4,1x),g14.6,2(1x,f8.5),'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho1(i),thrho2(i)
          if (lfit) then
            write(iout,'(1x,f8.4,1x,3i3,1x,3i2)') the,nint(threepoly(3,i)),(nint(threepoly(k,i)),k=1,2),(itmp(16*(i-1)+j),j=1,3)
          else
      ...
      elseif (nthrty(i).eq.24) then
        if (mmtexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''mm3angle bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            write(iout,'(3(a5,1x,a4,1x),g10.5,1x,g10.5,1x,f10.6,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,threepoly(1,i)
            write(iout,'(4x,4(g12.6,1x),7i2)') &
              (threepoly(j,i),j=2,5),(itmp(16*(i-1)+k),k=1,7)
          else
            write(iout,'(''mm3angle bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            write(iout,'(3(a5,1x,a4,1x),g10.5,1x,g10.5,1x,f10.6,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,threepoly(1,i)
            write(iout,'(4x,4(g12.6,1x))') &
              (threepoly(j,i),j=2,5)
          endif
        else
          write(iout,'(''mm3angle '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g10.5,1x,g10.5,1x,f10.6,'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,threepoly(1,i)
          write(iout,'(4x,4(g12.6,1x),'' &'')') &
            (threepoly(j,i),j=2,5)
          if (lfit) then
            write(iout,'(6(1x,f6.3),7i2)') &
              thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i),(itmp(16*(i-1)+k),k=1,7)
          else
            write(iout,'(6(1x,f6.3))') &
              thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i)
          endif
        endif
      elseif (nthrty(i).eq.25) then
        write(iout,'(''sw3 garofalini '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
        write(iout,'(3(a5,1x,a4,1x),g14.6,1x,f8.4,2(1x,f8.6),'' &'')') &
          lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,thrho1(i),thrho2(i)
        if (lfit) then
          write(iout,'(6(1x,f8.3),4i2)') &
      ...
      elseif (nthrty(i).eq.26) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''j3 bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          if (lfit) then
            write(iout,'(3(a5,1x,a3,1x),g11.5,1x,i2)') lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3), &
              thbk(i),itmp(16*(i-1)+1)
          else
            write(iout,'(3(a5,1x,a3,1x),g11.5)') lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i)
          endif
        else
          write(iout,'(''j3 '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a3,1x),g11.5,1x,'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i)
          if (lfit) then
            write(iout,'(6(1x,f8.3),i2)') thr1min(i),thr1(i), &
              thr2min(i),thr2(i),thr3min(i),thr3(i),itmp(16*(i-1)+1)
          else
            write(iout,'(6(1x,f8.3))') thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i)
          endif
        endif
      elseif (nthrty(i).eq.27) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''ppp3body bond '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          if (lfit) then
            write(iout,'(3(a5,1x,a4,1x),g14.6,3(1x,f8.6),4i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i), &
              ctmp(3),thbk(i),thrho1(i),thrho2(i),thrho3(i),itmp(16*(i-1)+1),(itmp(16*(i-1)+j),j=3,5)
          else
            write(iout,'(3(a5,1x,a4,1x),g14.6,3(1x,f7.5))') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho1(i),thrho2(i),thrho3(i)
          endif
        else
          write(iout,'(''ppp3body '',a5,5(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g14.6,3(1x,f8.6),'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho1(i),thrho2(i),thrho3(i)
          if (lfit) then
            write(iout,'(6(1x,f8.3),4i2)') &
              thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i),itmp(16*(i-1)+1),(itmp(16*(i-1)+j),j=3,5)
          else
            write(iout,'(6(1x,f8.3))') &
              thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i)
          endif
...
!
      if (lgenerated4(i).and..not.ldumpgenerated) cycle loop4body
!
!  Generate species labels
!
      nat1 = nfspec1(i)
        ...
        if (mmfexc(i).eq.1) then
          if (lfit) then
            ...
            write(iout,'(4(a5,1x,a3,1x),2(g10.5,1x),i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),itmp(6*(i-1)+1)
          else
            write(iout,'(''inversion squared bond '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
          ...
          if (lfit) then
            ...
            write(iout,'(4(a5,1x,a3,1x),2(g10.5,1x),3f6.3,i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4, &
              ctmp(4),fork(i),forpoly(1,i),for1(i),for2(i),for3(i),itmp(6*(i-1)+1)
          else
            write(iout,'(''inversion squared '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),2(g10.5,1x),3(f6.3,1x))') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),for1(i),for2(i),for3(i)
          endif
        endif
        ...
        if (mmfexc(i).eq.1) then
          if (lfit) then
            ...
            write(iout,'(4x,3(f8.4,1x),6i2)') &
              forpoly(3,i),forpoly(4,i),forpoly(5,i),(itmp(6*(i-1)+j),j=1,6)
          else
            write(iout,'(''xangleangle bond '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),3(g10.5,1x),'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),forpoly(2,i)
            write(iout,'(4x,3(f8.4,1x))') &
              forpoly(3,i),forpoly(4,i),forpoly(5,i)
          endif
        else
          if (lfit) then
            ...
            write(iout,'(4x,3(f8.4,1x),3(f6.3,1x),6i2)') &
              forpoly(3,i),forpoly(4,i),forpoly(5,i),for1(i),for2(i),for3(i), &
              (itmp(6*(i-1)+j),j=1,6)
          else
            write(iout,'(''xangleangle '',a5,3(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),3(g10.5,1x),'' &'')') &
