...
!
          if (ndim.gt.0.and.lstr) then
            do kl = 1,nstrains
              ks = nstrptr(kl)
              dqds(kl,iloc) = dqds(kl,iloc) + d1trm*dr2ds(ks)
            enddo
          endif
          if (lgrad2) then
!***********************
...
!
              ...
              ijyz = ijzz - 1
!
              d2qdxyz2(ijxx,iloc) = d2qdxyz2(ijxx,iloc) - d2trm*d2r2dx2(1)
              d2qdxyz2(ijxy,iloc) = d2qdxyz2(ijxy,iloc) - d2trm*d2r2dx2(6)
              d2qdxyz2(ijxz,iloc) = d2qdxyz2(ijxz,iloc) - d2trm*d2r2dx2(5)
              d2qdxyz2(ijyy,iloc) = d2qdxyz2(ijyy,iloc) - d2trm*d2r2dx2(2)
              d2qdxyz2(ijyz,iloc) = d2qdxyz2(ijyz,iloc) - d2trm*d2r2dx2(4)
              d2qdxyz2(ijzz,iloc) = d2qdxyz2(ijzz,iloc) - d2trm*d2r2dx2(3)
            ...
            if (ndim.gt.0.and.lstr) then
              ...
              do kk = 1,nstrains
                ...
                do kl = 1,kk
                  kt = nstrptr(kl)
                  ind = ind + 1
                  d2qds2(ind,iloc) = d2qds2(ind,iloc) + d2trm*dr2ds(ks)*dr2ds(kt) + d1trm*d2r2ds2(ks,kt)
                enddo
!
                d2qdxyzs(kk,jix,iloc) = d2qdxyzs(kk,jix,iloc) + d2trm*dr2ds(ks)*xji + d1trm*d2r2dsdx(ks,1)
                d2qdxyzs(kk,jiy,iloc) = d2qdxyzs(kk,jiy,iloc) + d2trm*dr2ds(ks)*yji + d1trm*d2r2dsdx(ks,2)
                d2qdxyzs(kk,jiz,iloc) = d2qdxyzs(kk,jiz,iloc) + d2trm*dr2ds(ks)*zji + d1trm*d2r2dsdx(ks,3)
              enddo
            endif
          endif
        endif
