...
!
  ...
  character(len=maxwordlength)  :: xrfile2
  character(len=maxwordlength)  :: xrfilel
  integer(i4)                   :: i
  integer(i4)                   :: i0(8)
  integer(i4)                   :: iend
  integer(i4)                   :: ii
...
!
      ...
      if (ncfg.gt.1) then
        write(ioout,'(''  XR file written for configuration '',i4,'' as '',a)') ncf,trim(xrfile2)
      else
        write(ioout,'(''  XR file written as '',a)') trim(xrfile2)
      endif
!
      call setup(.false.)
!
...
!
      if (ntitle.ge.1) then
        write(iout,'(i4,''   1'',1x,a)') numat,trim(titleword(1))
      else
