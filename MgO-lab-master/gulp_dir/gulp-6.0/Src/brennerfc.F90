...
!
        call d2addfc(j,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,ineigh,nREBOatomRptr,d1j,d2j,.true.)
!
...
!
    call d2addfc(i,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,ineigh,nREBOatomRptr,d1i,d2i,.true.)
  enddo
!
!  Free local memory
!
