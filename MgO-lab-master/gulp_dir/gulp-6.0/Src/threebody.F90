...
!
        ...
        e2 = 0.0_dp
        if (rkthb3.ne.0.0_dp) then
          e1 = e1 + 3.0_dp*rkthb3*delth
          e2 = 0.0_dp
        endif
        if (rkthb4.ne.0.0_dp) then
          e1 = e1 + 4.0_dp*rkthb4*delth2
          e2 = e2 + 8.0_dp*rkthb4
        endif
!
...
!$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    if (rkthb3.ne.0.0_dp) then 
      ethb = ethb + rkthb3*(costh - theta0)**3
    endif
    if (rkthb4.ne.0.0_dp) then 
      ethb = ethb + rkthb4*(costh - theta0)**4
    endif
    if (lgrad1) then
!
!  First derivatives
!
      ...
      if (rkthb3.ne.0.0_dp) then 
        e1 = e1 + 3.0_dp*rkthb3*(costh - theta0)**2
      endif
      if (rkthb4.ne.0.0_dp) then 
        e1 = e1 + 4.0_dp*rkthb4*(costh - theta0)**3
      endif
      e1d1 = e1*cos1d1
      e1d2 = e1*cos1d2
      e1d3 = e1*cos1d3
      if (lgrad2) then
        e2 = rkthb
        if (rkthb3.ne.0.0_dp) then 
          e2 = e2 + 6.0_dp*rkthb3*(costh - theta0)
        endif
        if (rkthb4.ne.0.0_dp) then 
          e2 = e2 + 12.0_dp*rkthb4*(costh - theta0)**2
        endif
!
!  Second derivatives
!
        ...
        if (lgrad3) then
          ...
          if (rkthb4.ne.0.0_dp) then 
            e3 = e3 + 24.0_dp*rkthb4*(costh - theta0)
          endif
!
!  Third derivatives
!
