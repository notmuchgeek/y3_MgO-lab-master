...
!
!  12/20 Work arounds for gfortran 10 added
!
  use datatypes
  use iochannels
...
!
    err1(1) = err
    call sendall(err1,1_i4,0_i4,"bcgsolve","err")
    err = err1(1)
!
  ...
  enddo
!
!  Send output vector from a single node to ensure consistent behaviour
!
  call sendall(x,n,0_i4,"bcgsolve","x")
!
!  Free workspace
!
  deallocate(zz)
...
!
  ...
  real(dp)                    :: tsuml
#ifdef TRACE
  call trace_in('sparseAdiagprecon')
#endif
!
...
!
  ...
  Vout(n) = Vin(n)
#ifdef TRACE
  call trace_out('sparseAdiagprecon')
#endif
