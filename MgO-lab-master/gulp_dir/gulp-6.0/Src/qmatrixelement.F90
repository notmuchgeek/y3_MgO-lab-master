...
!   2/18 Trace added
!  12/19 Minimum image added
!   7/20 Old 3D reciprocal space calculation reinstated
!   7/20 Fixes in minimum image case and shell subtraction for derivatives
!
!  On entry:
!
