  subroutine diagdyn(nk,mcv,maxd2loc,mcvmin,freq,fscale,eigr,eigi,ifail)
!
...
!   8/14 K point number added to arguments
!   2/18 Trace added
!
!  Conditions of use:
!
...
!
    call phoncopy2l(0_i4,derv2,dervi,eigr,maxd2,0_i4,0_i4,maxd2,mcv)
!
