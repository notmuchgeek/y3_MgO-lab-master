...
!
                if (lasu1) then
                  do kl = 1,6
                    rstrd(kl) = rstrd(kl) + ed11*dr2ds(kl,1)*rsfct
                    rstrd(kl) = rstrd(kl) + ed12*dr2ds(kl,2)*rsfct
                    rstrd(kl) = rstrd(kl) + ed13*dr2ds(kl,3)*rsfct
                  enddo
                endif
              endif
!*************************
