...
!   9/14 Corrections made to referencing of spline polynominals
!        for carbon pivot case
!   9/14 Referencing of cos(0.6082*pi) replaced with -1/3
!   2/18 Trace added
!
!  Conditions of use:
!
...
!
        ...
        if (lgrad1) then
          dGijkdcostheta = bGcosL(2) + costheta*(2.0_dp*bGcosL(3) + costheta*(3.0_dp*bGcosL(4) + costheta*(4.0_dp*bGcosL(5) + &
            costheta*(5.0_dp*bGcosL(6)))))
          dLijkdcostheta = bLcos(2,1) + costheta*(2.0_dp*bLcos(3,1) + costheta*(3.0_dp*bLcos(4,1) + costheta*(4.0_dp*bLcos(5,1) + &
            costheta*(5.0_dp*bLcos(6,1)))))
          dGijkdcostheta = dGijkdcostheta + Qi*(dLijkdcostheta - dGijkdcostheta)
          if (lgrad2) then
            d2Gijkdcostheta2 = 2.0_dp*bGcosL(3) + costheta*(6.0_dp*bGcosL(4) + costheta*(12.0_dp*bGcosL(5) +  &
              costheta*(20.0_dp*bGcosL(6))))
            d2Lijkdcostheta2 = 2.0_dp*bLcos(3,1) + costheta*(6.0_dp*bLcos(4,1) + costheta*(12.0_dp*bLcos(5,1) +  &
              costheta*(20.0_dp*bLcos(6,1))))
            d2Gijkdcostheta2 = d2Gijkdcostheta2 + Qi*(d2Lijkdcostheta2 - d2Gijkdcostheta2)
            if (lgrad3) then
              d3Gijkdcostheta3 = 6.0_dp*bGcosL(4) + costheta*(24.0_dp*bGcosL(5) + costheta*(60.0_dp*bGcosL(6)))
              d3Lijkdcostheta3 = 6.0_dp*bLcos(4,1) + costheta*(24.0_dp*bLcos(5,1) + costheta*(60.0_dp*bLcos(6,1)))
...
!
        if (costheta.le.-third.and.costheta.gt.-0.5_dp) then
          bGcosL(1:6) = bGcosCspecial(1:6,2)
        else
          bGcosL(1:6) = bGcos(1:6,1)
        endif
        Gijk = bGcosL(1) + costheta*(bGcosL(2) + costheta*(bGcosL(3) + costheta*(bGcosL(4) + &
               costheta*(bGcosL(5) + costheta*bGcosL(6)))))
        if (lgrad1) then
...
!
      ...
      if (lgrad1) then
        ...
        dQidNti = 0.0_dp
        dGijkdcostheta = bGcosL(2) + costheta*(2.0_dp*bGcosL(3) + costheta*(3.0_dp*bGcosL(4) + costheta*(4.0_dp*bGcosL(5) + &
          costheta*(5.0_dp*bGcosL(6) + costheta*(6.0_dp*bGcosL(7) + costheta*(7.0_dp*bGcosL(8)))))))
        if (lgrad2) then
          d2GijkdNti2 = 0.0_dp
          d2GijkdrdNti(1:3) = 0.0_dp
          d2Gijkdcostheta2 = 2.0_dp*bGcosL(3) + costheta*(6.0_dp*bGcosL(4) + costheta*(12.0_dp*bGcosL(5) +  &
            costheta*(20.0_dp*bGcosL(6) + costheta*(30.0_dp*bGcosL(7) + costheta*(42.0_dp*bGcosL(8))))))
          if (lgrad3) then
            d3Gijkdcostheta3 = 6.0_dp*bGcosL(4) + costheta*(24.0_dp*bGcosL(5) + costheta*(60.0_dp*bGcosL(6) + &
              costheta*(120.0_dp*bGcosL(7) + costheta*(210.0_dp*bGcosL(8)))))
          endif
        endif
      endif
    endif
