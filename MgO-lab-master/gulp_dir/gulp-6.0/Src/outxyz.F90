...
!   1/19 maxwordlength change added
!
!  Conditions of use:
!
...
!
  ...
  character(len=maxwordlength) :: xyzfile2
  character(len=maxwordlength) :: xyzfilel
  integer(i4)                  :: i
  integer(i4)                  :: ii
  integer(i4)                  :: incf
  integer(i4)                  :: ind
...
!
    if (lxyzmovie) then
      write(ioout,'(/,''  XYZ File open for Movie as '',a,/)') trim(xyzfile2)
    else
      write(ioout,'(/,''  XYZ File written as '',a,/)') trim(xyzfile2)
    endif
  endif
!***********************
!  Configuration dump  *
