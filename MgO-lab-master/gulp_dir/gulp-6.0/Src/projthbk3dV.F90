...
!
      gruen = gruen + dfed1r + dfed1i + dfed1
      gruen = gruen + dfed2r + dfed2i + dfed2
    enddo
  enddo
#ifdef TRACE
  call trace_out('projthbk3dV')
#endif
!
  return
  end
