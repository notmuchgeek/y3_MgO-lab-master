...
!   4/16 Default value of n4botype(2,i) corrected to 1
!   3/19 Setting of lmorse flag corrected
!
!  Conditions of use:
!
...
!
  use g_constants,     only : kcaltoev, degtorad
...
!
  lmorse = (index(keyword,'umo').eq.1.or.index(keyword,' umo').ne.0)
!
