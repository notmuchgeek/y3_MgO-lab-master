...
!
  ...
  real(dp)         :: volume
#ifdef TRACE
  call trace_in('pr_update_velocities')
#endif
!
...
!
  ...
  enddo
#ifdef TRACE
  call trace_out('pr_update_velocities')
#endif
  return
...
! NB: refct converts to eV from mass*velocity**2
  ...
  real(dp)    :: partekin
#ifdef TRACE
  call trace_in('compute_partial_ekin')
#endif
...
! NB: refct converts to eV from mass*velocity**2
...
#ifdef TRACE
  call trace_out('compute_partial_ekin')
#endif
  ...
  integer(i4) :: i
#ifdef TRACE
  call trace_in('compute_kinstress')
#endif
...
#ifdef TRACE
  call trace_out('compute_kinstress')
#endif
  return
...
!
  if (ltethered) return
#ifdef TRACE
  call trace_in('pr_remove_torque')
#endif
!
...
!
  ...
  enddo
#ifdef TRACE
  call trace_out('pr_remove_torque')
#endif
