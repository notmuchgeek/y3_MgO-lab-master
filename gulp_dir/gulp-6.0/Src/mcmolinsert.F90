...
!
    ii = nptrtrialatom(i)
    call cart2frac(ndim,dx+xmid,dy+ymid,dz+zmid,rv,xafrac(ii),yafrac(ii),zafrac(ii),icx,icy,icz)
  enddo
!*********************
!  Set up molecules  *
!*********************
