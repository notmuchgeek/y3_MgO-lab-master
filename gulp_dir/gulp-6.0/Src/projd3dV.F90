  subroutine projd3dV(mcv,d3rs,d3is,d3s,i,ix,iy,iz,j,jx,jy,jz,lcorei,lcorej, &
                      rmassi,rmassj,derv2,dervi,eigr,eigi,maxd2,grueneisen,d33s,d33rs,d33is, &
