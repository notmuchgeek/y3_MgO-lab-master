  subroutine projthbk3ddV(nthbk,d33s,d33rs,dt11,dt21,dt31,dt22,dt32,dt33,gruen)
!
!  Calculates the frequency derivative contribution from the
!  third atom k for the i-i dynamical matrix block (on diagonal)
!  to the volume derivative.
!
!   1/18 Created from projthbk3ds
!   2/18 Trace added
!
!  Conditions of use:
!
...
!
      gruen = gruen + dfed1r + dfed2r
    enddo
  enddo
#ifdef TRACE
  call trace_out('projthbk3ddV')
#endif
!
  return
  end
