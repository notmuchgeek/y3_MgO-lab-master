...
!
      if (lgrad1) then
        if (ldsl) then
          ...
          if (lilocal) then
            call d1add(j,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nREBOatomRptr,d1j,.true.,.false.)
          endif
        endif
        if (lgrad2) then
          if (ldsl) then
            ...
            call d2addddm(j,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nREBOatomRptr,nr1,d1j,d2j,.true.)
          endif
        endif
      endif
!
...
!
    if (lgrad1) then
      if (ldsl) then
        ...
        if (lilocal) then
          call d1add(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nREBOatomRptr,d1i,.true.,.false.)
        endif
      endif
      if (lgrad2) then
        if (ldsl) then
          ...
          call d2addddm(i,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nREBOatomRptr,nr1,d1i,d2i,.true.)
        endif
      endif
    endif
  enddo iloop
