...
!  Unphased version
!
!  10/14 Created from sixp
!  12/14 Error in cell indices corrected
!   1/15 Error in cell indices for self terms corrected
...
!   4/17 Loop numbers replaced with labels
!   2/18 Trace added
!
!  Conditions of use:
!
...
!
                            if (ia.gt.ja) then
                              d2cell(isxyz(1,ja),isxyz(1,ia),ncindp(ivec)) = &
                                d2cell(isxyz(1,ja),isxyz(1,ia),ncindp(ivec)) - e1d(ivec)
                              d2cell(isxyz(2,ja),isxyz(2,ia),ncindp(ivec)) = &
                                d2cell(isxyz(2,ja),isxyz(2,ia),ncindp(ivec)) - e1d(ivec)
                              d2cell(isxyz(3,ja),isxyz(3,ia),ncindp(ivec)) = &
                                d2cell(isxyz(3,ja),isxyz(3,ia),ncindp(ivec)) - e1d(ivec)
                              d2cell(isxyz(1,ia),isxyz(1,ja),ncindm(ivec)) = &
                                d2cell(isxyz(1,ia),isxyz(1,ja),ncindm(ivec)) - e1d(ivec)
                              d2cell(isxyz(2,ia),isxyz(2,ja),ncindm(ivec)) = &
                                d2cell(isxyz(2,ia),isxyz(2,ja),ncindm(ivec)) - e1d(ivec)
                              d2cell(isxyz(3,ia),isxyz(3,ja),ncindm(ivec)) = &
                                d2cell(isxyz(3,ia),isxyz(3,ja),ncindm(ivec)) - e1d(ivec)
                            else
                              d2cell(isxyz(1,ja),isxyz(1,ia),ncindm(ivec)) = &
                                d2cell(isxyz(1,ja),isxyz(1,ia),ncindm(ivec)) - e1d(ivec)
                              d2cell(isxyz(2,ja),isxyz(2,ia),ncindm(ivec)) = &
                                d2cell(isxyz(2,ja),isxyz(2,ia),ncindm(ivec)) - e1d(ivec)
                              d2cell(isxyz(3,ja),isxyz(3,ia),ncindm(ivec)) = &
                                d2cell(isxyz(3,ja),isxyz(3,ia),ncindm(ivec)) - e1d(ivec)
                              d2cell(isxyz(1,ia),isxyz(1,ja),ncindp(ivec)) = &
                                d2cell(isxyz(1,ia),isxyz(1,ja),ncindp(ivec)) - e1d(ivec)
                              d2cell(isxyz(2,ia),isxyz(2,ja),ncindp(ivec)) = &
                                d2cell(isxyz(2,ia),isxyz(2,ja),ncindp(ivec)) - e1d(ivec)
                              d2cell(isxyz(3,ia),isxyz(3,ja),ncindp(ivec)) = &
                                d2cell(isxyz(3,ia),isxyz(3,ja),ncindp(ivec)) - e1d(ivec)
                            endif
!
                            do jvec = ivec,15
                              indvec = indvec + 1 
                              ...
                              do ialp = 1,3
                                do ibet = 1,3
                                  ...
                                  if (ia.gt.ib) then
                                    d2cell(isxyz(ibet,ib),isxyz(ialp,ia),ncindp(kb2(ib,ia))) =  &
                                      d2cell(isxyz(ibet,ib),isxyz(ialp,ia),ncindp(kb2(ib,ia))) + d2trm
                                  elseif (ia.lt.ib) then
                                    d2cell(isxyz(ibet,ib),isxyz(ialp,ia),ncindm(kb2(ib,ia))) =  &
                                      d2cell(isxyz(ibet,ib),isxyz(ialp,ia),ncindm(kb2(ib,ia))) + d2trm
                                  endif
!
                                  if (ia.gt.jb) then
                                    d2cell(isxyz(ibet,jb),isxyz(ialp,ia),ncindp(kb2(jb,ia))) = &
                                      d2cell(isxyz(ibet,jb),isxyz(ialp,ia),ncindp(kb2(jb,ia))) - d2trm
                                  elseif (ia.lt.jb) then
                                    d2cell(isxyz(ibet,jb),isxyz(ialp,ia),ncindm(kb2(jb,ia))) = &
                                      d2cell(isxyz(ibet,jb),isxyz(ialp,ia),ncindm(kb2(jb,ia))) - d2trm
                                  endif
!
                                  if (ja.gt.jb) then
                                    d2cell(isxyz(ibet,jb),isxyz(ialp,ja),ncindp(kb2(jb,ja))) = &
                                      d2cell(isxyz(ibet,jb),isxyz(ialp,ja),ncindp(kb2(jb,ja))) + d2trm
                                  elseif (ja.lt.jb) then
                                    d2cell(isxyz(ibet,jb),isxyz(ialp,ja),ncindm(kb2(jb,ja))) = &
                                      d2cell(isxyz(ibet,jb),isxyz(ialp,ja),ncindm(kb2(jb,ja))) + d2trm
                                  endif
!
                                  if (ja.gt.ib) then
                                    d2cell(isxyz(ibet,ib),isxyz(ialp,ja),ncindp(kb2(ib,ja))) = &
                                      d2cell(isxyz(ibet,ib),isxyz(ialp,ja),ncindp(kb2(ib,ja))) - d2trm
                                  elseif (ja.lt.ib) then
                                    d2cell(isxyz(ibet,ib),isxyz(ialp,ja),ncindm(kb2(ib,ja))) = &
                                      d2cell(isxyz(ibet,ib),isxyz(ialp,ja),ncindm(kb2(ib,ja))) - d2trm
                                  endif
!
                                  if (ivec.ne.jvec) then
                                    if (ia.gt.ib) then
                                      d2cell(isxyz(ialp,ia),isxyz(ibet,ib),ncindm(kb2(ia,ib))) = &
                                      d2cell(isxyz(ialp,ia),isxyz(ibet,ib),ncindm(kb2(ia,ib))) + d2trm
                                    elseif (ia.lt.ib) then
                                      d2cell(isxyz(ialp,ia),isxyz(ibet,ib),ncindp(kb2(ia,ib))) = &
                                      d2cell(isxyz(ialp,ia),isxyz(ibet,ib),ncindp(kb2(ia,ib))) + d2trm
                                    endif
!
                                    if (ia.gt.jb) then
                                      d2cell(isxyz(ialp,ia),isxyz(ibet,jb),ncindm(kb2(ia,jb))) = &
                                      d2cell(isxyz(ialp,ia),isxyz(ibet,jb),ncindm(kb2(ia,jb))) - d2trm
                                    elseif (ia.lt.jb) then
                                      d2cell(isxyz(ialp,ia),isxyz(ibet,jb),ncindp(kb2(ia,jb))) = &
                                      d2cell(isxyz(ialp,ia),isxyz(ibet,jb),ncindp(kb2(ia,jb))) - d2trm
                                    endif
!
                                    if (ja.gt.jb) then
                                      d2cell(isxyz(ialp,ja),isxyz(ibet,jb),ncindm(kb2(ja,jb))) = &
                                      d2cell(isxyz(ialp,ja),isxyz(ibet,jb),ncindm(kb2(ja,jb))) + d2trm
                                    elseif (ja.lt.jb) then
                                      d2cell(isxyz(ialp,ja),isxyz(ibet,jb),ncindp(kb2(ja,jb))) = &
                                      d2cell(isxyz(ialp,ja),isxyz(ibet,jb),ncindp(kb2(ja,jb))) + d2trm
                                    endif
!
                                    if (ja.gt.ib) then
                                      d2cell(isxyz(ialp,ja),isxyz(ibet,ib),ncindm(kb2(ja,ib))) = &
                                      d2cell(isxyz(ialp,ja),isxyz(ibet,ib),ncindm(kb2(ja,ib))) - d2trm
                                    elseif (ja.lt.ib) then
                                      d2cell(isxyz(ialp,ja),isxyz(ibet,ib),ncindp(kb2(ja,ib))) = &
                                      d2cell(isxyz(ialp,ja),isxyz(ibet,ib),ncindp(kb2(ja,ib))) - d2trm
                                    endif
                                  endif
                                enddo
                              enddo
