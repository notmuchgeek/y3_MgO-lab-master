        ...
        if (leshift(i)) then
          if (lgshift(i)) then
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''buck grad '',a5,1x,a4,1x,a3,2(1x,a9))')  &
              ...
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''buck grad '',a4,1x,a3,2(1x,a9))')  &
            ...
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''buck energy '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                    mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
              ...
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''buck energy '',a4,1x,a3,2(1x,a9))')  &
                    mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
          ...
          if (nmptr.gt.0) then
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''buck '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                  mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
            ...
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''buck'',1x,a4,1x,a3,2(1x,a9))')  &
                  mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
          ...
          if (leshift(i)) then
            if (lgshift(i)) then
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    if (lnoninteger) then
                      write(iout,'(''lennard combine grad '',f7.4,1x,f7.4,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                        tpot(1,i),tpot(2,i),mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                    else
                      write(iout,'(''lennard combine grad '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                ...
                if (l14scale) then
                  if (l14frac) then
                    if (lnoninteger) then
                      write(iout,'(''lennard combine grad '',f7.4,1x,f7.4,1x,a4,1x,a3,2(1x,a9))') &
                        tpot(1,i),tpot(2,i),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                    else
                      write(iout,'(''lennard combine grad '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))') &
              ...
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    if (lnoninteger) then
                      write(iout,'(''lennard combine ener '',f7.4,1x,f7.4,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                        tpot(1,i),tpot(2,i),mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                    else
                      write(iout,'(''lennard combine ener '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                        im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                    endif
                  else
                    if (lnoninteger) then
                ...
                if (l14scale) then
                  if (l14frac) then
                    if (lnoninteger) then
                      write(iout,'(''lennard combine ener '',f7.4,1x,f7.4,1x,a4,1x,a3,2(1x,a9))') &
                        tpot(1,i),tpot(2,i),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                    else
                      write(iout,'(''lennard combine ener '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))') &
                        im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                    endif
                  else
                    if (lnoninteger) then
            ...
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  if (lnoninteger) then
                    write(iout,'(''lennard combine '',f7.4,1x,f7.4,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                      tpot(1,i),tpot(2,i),mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''lennard combine '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                      im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  if (lnoninteger) then
              ...
              if (l14scale) then
                if (l14frac) then
                  if (lnoninteger) then
                    write(iout,'(''lennard combine '',f7.4,1x,f7.4,1x,a4,1x,a3,2(1x,a9))') &
                      tpot(1,i),tpot(2,i),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''lennard combine '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))') &
                      im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  if (lnoninteger) then
          ...
          if (leshift(i)) then
            if (lgshift(i)) then
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    if (lnoninteger) then
                      write(iout,'(''lennard grad '',f7.4,1x,f7.4,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                        tpot(1,i),tpot(2,i),mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                    else
                      write(iout,'(''lennard grad '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                        im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                    endif
                  else
                    if (lnoninteger) then
                ...
                if (l14scale) then
                  if (l14frac) then
                    if (lnoninteger) then
                      write(iout,'(''lennard grad '',f7.4,1x,f7.4,1x,a4,1x,a3,2(1x,a9))') &
                        tpot(1,i),tpot(2,i),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                    else
                      write(iout,'(''lennard grad '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))') &
                        im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                    endif
                  else
                    if (lnoninteger) then
              ...
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    if (lnoninteger) then
                      write(iout,'(''lennard ener '',f7.4,1x,f7.4,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                        tpot(1,i),tpot(2,i),mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                    else
                      write(iout,'(''lennard ener '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                        im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                    endif
                  else
                    if (lnoninteger) then
                ...
                if (l14scale) then
                  if (l14frac) then
                    if (lnoninteger) then
                      write(iout,'(''lennard ener '',f7.4,1x,f7.4,1x,a4,1x,a3,2(1x,a9))') &
                        tpot(1,i),tpot(2,i),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                    else
                      write(iout,'(''lennard ener '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))') &
                        im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                    endif
                  else
                    if (lnoninteger) then
            ...
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  if (lnoninteger) then
                    write(iout,'(''lennard '',f7.4,1x,f7.4,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                      tpot(1,i),tpot(2,i),mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''lennard '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                      im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  if (lnoninteger) then
              ...
              if (l14scale) then
                if (l14frac) then
                  if (lnoninteger) then
                    write(iout,'(''lennard '',f7.4,1x,f7.4,1x,a4,1x,a3,2(1x,a9))')  &
                      tpot(1,i),tpot(2,i),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''lennard '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))')  &
                      im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  if (lnoninteger) then
        ...
        if (leshift(i)) then
          if (lgshift(i)) then
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  if (lzero) then
                    write(iout,'(''morse grad zero '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''morse grad '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  if (lzero) then
                    write(iout,'(''morse grad zero '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                      mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                  else
                ...
                if (lzero) then
                  write(iout,'(''morse grad zero '',a5,1x,a4,2(1x,a9))')  &
                    mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
                else
              ...
              if (l14scale) then
                if (l14frac) then
                  if (lzero) then
                    write(iout,'(''morse grad zero'',1x,a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''morse grad'',1x,a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  if (lzero) then
                    write(iout,'(''morse grad zero'',1x,a4,1x,f6.4,2(1x,a9))')  &
                      mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                  else
                ...
                if (lzero) then
                  write(iout,'(''morse grad zero'',1x,a4,2(1x,a9))')  &
                    mmword,(botyword(nbotyptr(j)),j=1,nboty)
                else
            ...
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  if (lzero) then
                    write(iout,'(''morse energy zero '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''morse energy '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  if (lzero) then
                    write(iout,'(''morse energy zero '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                      mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                  else
                ...
                if (lzero) then
                  write(iout,'(''morse energy zero '',a5,1x,a4,2(1x,a9))')  &
                    mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
                else
              ...
              if (l14scale) then
                if (l14frac) then
                  if (lzero) then
                    write(iout,'(''morse energy zero'',1x,a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''morse energy'',1x,a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  if (lzero) then
                    write(iout,'(''morse energy zero'',1x,a4,1x,f6.4,2(1x,a9))')  &
                      mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                  else
                ...
                if (lzero) then
                  write(iout,'(''morse energy zero'',1x,a4,2(1x,a9))')  &
                    mmword,(botyword(nbotyptr(j)),j=1,nboty)
                else
          ...
          if (nmptr.gt.0) then
            if (l14scale) then
              if (l14frac) then
                if (lzero) then
                  write(iout,'(''morse zero '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                    mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
                  write(iout,'(''morse '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                    mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (lzero) then
                  write(iout,'(''morse zero '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                    mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                else
              ...
              if (lzero) then
                write(iout,'(''morse zero '',a5,1x,a4,2(1x,a9))')  &
                  mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
              else
            ...
            if (l14scale) then
              if (l14frac) then
                if (lzero) then
                  write(iout,'(''morse zero'',1x,a4,1x,a3,2(1x,a9))')  &
                    mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
                  write(iout,'(''morse'',1x,a4,1x,a3,2(1x,a9))')  &
                    mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (lzero) then
                  write(iout,'(''morse zero'',1x,a4,1x,f6.4,2(1x,a9))')  &
                    mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                else
              ...
              if (lzero) then
                write(iout,'(''morse zero'',1x,a4,2(1x,a9))')  &
                  mmword,(botyword(nbotyptr(j)),j=1,nboty)
              else
          ...
          if (leshift(i)) then
            if (lgshift(i)) then
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic k3 k4 grad '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                ...
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic k3 k4 grad '',a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
              ...
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic k3 k4 energy '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                ...
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic k3 k4 energy '',a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
            ...
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''harmonic k3 k4 '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                    mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
              ...
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''harmonic k3 k4 '',a4,1x,a3,2(1x,a9))')  &
                    mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
          ...
          if (leshift(i)) then
            if (lgshift(i)) then
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic k3 grad '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                ...
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic k3 grad '',a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
              ...
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic k3 energy '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                ...
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic k3 energy '',a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
            ...
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''harmonic k3 '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                    mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
              ...
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''harmonic k3 '',a4,1x,a3,2(1x,a9))')  &
                    mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
          ...
          if (leshift(i)) then
            if (lgshift(i)) then
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic k4 grad '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                ...
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic k4 grad '',a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
              ...
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic k4 energy '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                ...
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic k4 energy '',a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
            ...
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''harmonic k4 '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                    mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
              ...
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''harmonic k4 '',a4,1x,a3,2(1x,a9))')  &
                    mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
          ...
          if (leshift(i)) then
            if (lgshift(i)) then
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic grad '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                ...
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic grad '',a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
              ...
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic energy '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                ...
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''harmonic energy '',a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
            ...
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''harmonic '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                    mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
              ...
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''harmonic '',a4,1x,a3,2(1x,a9))')  &
                    mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
        ...
        if (leshift(i)) then
          if (lgshift(i)) then
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''general '',a5,'' grad '',2i3,1x,a4,1x,a3,2(1x,a9))')  &
              ...
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''general grad '',2i3,1x,a4,1x,a3,2(1x,a9))') &
            ...
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''general '',a5,'' ener '',2i3,1x,a4,1x,a3,2(1x,a9))') &
                    mword(nmptr),mpt,npt,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
              ...
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''general ener '',2i3,1x,a4,1x,a3,2(1x,a9))')  &
                    mpt,npt,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
          ...
          if (nmptr.gt.0) then
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''general '',a5,1x,2i3,1x,a4,1x,a3,2(1x,a9))')  &
                  mword(nmptr),mpt,npt,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
            ...
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''general '',2i3,1x,a4,1x,a3,2(1x,a9))')  &
                  mpt,npt,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''coulomb_subtract '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''coulomb_subtract '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''coulomb_subtract '',a5,1x,a4,2(1x,a9))')  &
              mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
          endif
        else
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''coulomb_subtract '',a4,1x,a3,2(1x,a9))')  &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''coulomb_subtract '',a4,1x,f6.4,2(1x,a9))')  &
                mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''coulomb_subtract '',a4,2(1x,a9))')  &
              mmword,(botyword(nbotyptr(j)),j=1,nboty)
          endif
        endif
        if (lfit) then
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''buck4 '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''buck4'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''spline '',a5,1x,a7,1x,a4,1x,a3,2(1x,a9))') &
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''spline '',a7,1x,a4,1x,a3,2(1x,a9))') &
        ...
        if (lcombine(i)) then
          if (nmptr.gt.0) then
            if (l14scale) then
              if (l14frac) then
                if (ncombipower(i).eq.6) then
                  write(iout,'(''lenn epsilon zero combine '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                    im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.2) then
                  write(iout,'(''lenn epsilon zero geometric '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                    im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.1) then
                  write(iout,'(''lenn epsilon zero product '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                    im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (ncombipower(i).eq.6) then
            ...
            if (l14scale) then
              if (l14frac) then
                if (ncombipower(i).eq.6) then
                  write(iout,'(''lenn epsilon zero combine '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))') &
                    im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.2) then
                  write(iout,'(''lenn epsilon zero geometric '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))') &
                    im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.1) then
                  write(iout,'(''lenn epsilon zero product '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))') &
                    im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (ncombipower(i).eq.6) then
          ...
          if (nmptr.gt.0) then
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''lenn epsilon zero '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                  im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
            ...
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''lenn epsilon zero '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))') &
                  im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
        ...
        if (lcombine(i)) then
          if (nmptr.gt.0) then
            if (l14scale) then
              if (l14frac) then
                if (lnoninteger) then
                  if (ncombipower(i).eq.6) then
                    write(iout,'(''lenn epsilon combine '',f7.4,1x,f7.4,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                      tpot(1,i),tpot(2,i),mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  elseif (ncombipower(i).eq.2) then
                    write(iout,'(''lenn epsilon geometric '',f7.4,1x,f7.4,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                      tpot(1,i),tpot(2,i),mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  elseif (ncombipower(i).eq.1) then
                    write(iout,'(''lenn epsilon product '',f7.4,1x,f7.4,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                      tpot(1,i),tpot(2,i),mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  if (ncombipower(i).eq.6) then
                    write(iout,'(''lenn epsilon combine '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                      im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  elseif (ncombipower(i).eq.2) then
                    write(iout,'(''lenn epsilon geometric '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                      im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  elseif (ncombipower(i).eq.1) then
                    write(iout,'(''lenn epsilon product '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                      im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                endif
              else
            ...
            if (l14scale) then
              if (l14frac) then
                if (lnoninteger) then
                  if (ncombipower(i).eq.6) then
                    write(iout,'(''lenn epsilon combine '',f7.4,1x,f7.4,1x,a4,1x,a3,2(1x,a9))')  &
                      tpot(1,i),tpot(2,i),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  elseif (ncombipower(i).eq.2) then
                    write(iout,'(''lenn epsilon geometric '',f7.4,1x,f7.4,1x,a4,1x,a3,2(1x,a9))')  &
                      tpot(1,i),tpot(2,i),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  elseif (ncombipower(i).eq.1) then
                    write(iout,'(''lenn epsilon product '',f7.4,1x,f7.4,1x,a4,1x,a3,2(1x,a9))')  &
                      tpot(1,i),tpot(2,i),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  if (ncombipower(i).eq.6) then
                    write(iout,'(''lenn epsilon combine '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))')  &
                      im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  elseif (ncombipower(i).eq.2) then
                    write(iout,'(''lenn epsilon geometric '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))')  &
                      im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  elseif (ncombipower(i).eq.1) then
                    write(iout,'(''lenn epsilon product '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))')  &
                      im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                endif
              else
          ...
          if (nmptr.gt.0) then
            if (l14scale) then
              if (l14frac) then
                if (lnoninteger) then
                  write(iout,'(''lenn epsilon '',f7.4,1x,f7.4,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                    tpot(1,i),tpot(2,i),mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
                  write(iout,'(''lenn epsilon '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                    im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (lnoninteger) then
            ...
            if (l14scale) then
              if (l14frac) then
                if (lnoninteger) then
                  write(iout,'(''lenn epsilon '',f7.4,1x,f7.4,1x,a4,1x,a3,2(1x,a9))')  &
                    tpot(1,i),tpot(2,i),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
                  write(iout,'(''lenn epsilon '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))')  &
                    im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (lnoninteger) then
                  write(iout,'(''lenn epsilon '',f7.4,1x,f7.4,1x,a4,1x,f6.4,2(1x,a9))')  &
                    tpot(1,i),tpot(2,i),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                else
                  write(iout,'(''lenn epsilon '',i2,1x,i2,1x,a4,1x,f6.4,2(1x,a9))')  &
                    im,in,mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                endif
              endif
            else
              if (lnoninteger) then
                write(iout,'(''lenn epsilon '',f7.4,1x,f7.4,1x,a4,2(1x,a9))')  &
                  tpot(1,i),tpot(2,i),mmword,(botyword(nbotyptr(j)),j=1,nboty)
              else
                write(iout,'(''lenn epsilon '',i2,1x,i2,1x,a4,2(1x,a9))')  &
                  im,in,mmword,(botyword(nbotyptr(j)),j=1,nboty)
              endif
            endif
          endif
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''sw2 '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''sw2'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
        ...
        if (leshift(i)) then
          if (lgshift(i)) then
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''igauss grad '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                    mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
              ...
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''igauss grad '',a4,1x,a3,2(1x,a9))')  &
                    mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
            ...
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''igauss energy '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                    mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
              ...
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''igauss energy '',a4,1x,a3,2(1x,a9))')  &
                    mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
          ...
          if (nmptr.gt.0) then
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''igauss '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                  mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
            ...
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''igauss'',1x,a4,1x,a3,2(1x,a9))')  &
                  mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''damped_dispersion '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''damped_dispersion'',1x,a4,1x,a3,2(1x,a9))')  &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''qtaper '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''qtaper'',1x,a4,1x,a3,2(1x,a9))')  &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        ...
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''polynomial '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''polynomial'',1x,a4,1x,a3,2(1x,a9))')  &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        ...
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''lennard esff '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))')  &
                im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''lennard esff '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))')  &
                im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''covexp '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''covexp'',1x,a4,1x,a3,2(1x,a9))')  &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (lgshift(i)) then
          if (nmptr.gt.0) then
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''fermi-dirac grad '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                  mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
            ...
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''fermi-dirac grad'',1x,a4,1x,a3,2(1x,a9))')  &
                  mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
        ...
        elseif (leshift(i)) then
          if (nmptr.gt.0) then
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''fermi-dirac energy '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                  mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
            ...
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''fermi-dirac energy'',1x,a4,1x,a3,2(1x,a9))')  &
                  mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
          ...
          if (nmptr.gt.0) then
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''fermi-dirac '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                  mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
            ...
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''fermi-dirac'',1x,a4,1x,a3,2(1x,a9))')  &
                  mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
...
!
        ...
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''ljbuffered '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))')  &
                im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''ljbuffered '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))')  &
                im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
        ...
        if (leshift(i)) then
          if (lgshift(i)) then
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''squaredharmonic grad '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                    mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
              ...
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''squaredharmonic grad '',a4,1x,a3,2(1x,a9))')  &
                    mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
            ...
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''squaredharmonic energy '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                    mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
              ...
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''squaredharmonic energy '',a4,1x,a3,2(1x,a9))')  &
                    mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
          ...
          if (nmptr.gt.0) then
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''squaredharmonic '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                  mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
            ...
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''squaredharmonic '',a4,1x,a3,2(1x,a9))')  &
                  mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              if (nint(tpot(1,i)).eq.2) then
                write(iout,'(''tsuneyuki form2 '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                  mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
          ...
          if (l14scale) then
            if (l14frac) then
              if (nint(tpot(1,i)).eq.2) then
                write(iout,'(''tsuneyuki form2'',1x,a4,1x,a3,2(1x,a9))')  &
                  mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
...
!  
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''sw2jb '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then 
            if (l14frac) then
              write(iout,'(''sw2jb'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''eam_potential_shift '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''eam_potential_shift'',1x,a4,1x,a3,2(1x,a9))')  &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        ...
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''polynomial harmonic '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''polynomial harmonic'',1x,a4,1x,a3,2(1x,a9))')  &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''forceconstant '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''forceconstant '',a4,1x,a3,2(1x,a9))')  &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''srglue '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''srglue'',1x,a4,1x,a3,2(1x,a9))')  &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''morse etaper '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''morse etaper '',a4,1x,a3,2(1x,a9))')  &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!  
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''mei-davenport '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then 
            if (l14frac) then
              write(iout,'(''mei-davenport'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''erferfc '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''erferfc '',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''reperfc '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''reperfc '',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
! 
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''erfpot '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''erfpot '',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''baskes'',1x,i2,1x,a7,1x,a4,1x,a3,2(1x,a9))') &
                ipot(1,i),meamlatticetype(ipot(2,i)),mmword,scaleword, &
                (botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''baskes'',1x,i2,1x,a7,1x,a4,1x,f6.4,2(1x,a9))') &
                ipot(1,i),meamlatticetype(ipot(2,i)),mmword,scale14(i), &
                (botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''baskes'',1x,i2,1x,a7,1x,a4,2(1x,a9))') &
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''vbo_twobody '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''vbo_twobody'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''exppowers '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''exppowers'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''grimme_c6 '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''grimme_c6'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''cfm_harmonic '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''cfm_harmonic'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
! 
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''cfm_gaussian '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''cfm_gaussian'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
! 
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''cfm_power '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''cfm_power'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
! 
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''cfm_fermi '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''cfm_fermi'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''gcoulomb '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''gcoulomb'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''becke_johnson_c6 '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
          ...
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''becke_johnson_c6'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''baskes a4 '',i2,1x,a7,1x,a5,1x,a4,1x,a3,2(1x,a9))')  &
                ipot(1,i),meamlatticetype(ipot(2,i)),mword(nmptr),mmword,scaleword, &
                (botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''baskes a4 '',i2,1x,a7,1x,a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                ipot(1,i),meamlatticetype(ipot(2,i)),mword(nmptr),mmword,scale14(i), &
                (botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''baskes a4 '',i2,1x,a7,1x,a5,1x,a4,2(1x,a9))')  &
              ipot(1,i),meamlatticetype(ipot(2,i)),mword(nmptr),mmword, &
              (botyword(nbotyptr(j)),j=1,nboty)
          endif
        else
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''baskes a4 '',i2,1x,a7,1x,a4,1x,a3,2(1x,a9))') &
                ipot(1,i),meamlatticetype(ipot(2,i)),mmword,scaleword, &
                (botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''baskes a4 '',i2,1x,a7,1x,a4,1x,f6.4,2(1x,a9))') &
                ipot(1,i),meamlatticetype(ipot(2,i)),mmword,scale14(i), &
                (botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''baskes a4 '',i2,1x,a7,1x,a4,2(1x,a9))') &
              ipot(1,i),meamlatticetype(ipot(2,i)),mmword, &
              (botyword(nbotyptr(j)),j=1,nboty)
          endif
        endif
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''zbl '',1x,a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword, &
                (botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''zbl '',1x,a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                mword(nmptr),mmword,scale14(i), &
                (botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''zbl '',1x,a5,1x,a4,2(1x,a9))')  &
              mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
          endif
        else
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''zbl '',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''zbl '',1x,a4,1x,f6.4,2(1x,a9))') &
                mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''zbl '',1x,a4,2(1x,a9))') &
              mmword,(botyword(nbotyptr(j)),j=1,nboty)
          endif
        endif
          ...
          if (leshift(i)) then
            if (lgshift(i)) then
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''mm3buck combine grad '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''mm3buck combine grad '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                      mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  write(iout,'(''mm3buck combine grad '',a5,1x,a4,2(1x,a9))')  &
                    mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''mm3buck combine grad '',a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''mm3buck combine grad '',a4,1x,f6.4,2(1x,a9))')  &
                      mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  write(iout,'(''mm3buck combine grad '',a4,2(1x,a9))')  &
                    mmword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              endif
            else
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''mm3buck combine energy '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''mm3buck combine energy '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                      mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  write(iout,'(''mm3buck combine energy '',a5,1x,a4,2(1x,a9))')  &
                    mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''mm3buck combine energy '',a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''mm3buck combine energy '',a4,1x,f6.4,2(1x,a9))')  &
                      mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  write(iout,'(''mm3buck combine energy '',a4,2(1x,a9))')  &
                    mmword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              endif
            endif
            ...
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''mm3buck combine '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                    mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
                  write(iout,'(''mm3buck combine '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                    mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                write(iout,'(''mm3buck combine '',a5,1x,a4,2(1x,a9))')  &
                  mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
              endif
            else
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''mm3buck combine'',1x,a4,1x,a3,2(1x,a9))')  &
                    mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
                  write(iout,'(''mm3buck combine'',1x,a4,1x,f6.4,2(1x,a9))')  &
                    mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                write(iout,'(''mm3buck combine'',1x,a4,2(1x,a9))')  &
                  mmword,(botyword(nbotyptr(j)),j=1,nboty)
              endif
            endif
          endif
          ...
          if (leshift(i)) then
            if (lgshift(i)) then
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''mm3buck grad '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''mm3buck grad '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                      mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  write(iout,'(''mm3buck grad '',a5,1x,a4,2(1x,a9))')  &
                    mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''mm3buck grad '',a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''mm3buck grad '',a4,1x,f6.4,2(1x,a9))')  &
                      mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  write(iout,'(''mm3buck grad '',a4,2(1x,a9))')  &
                    mmword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              endif
            else
              if (nmptr.gt.0) then
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''mm3buck energy '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                      mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''mm3buck energy '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                      mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  write(iout,'(''mm3buck energy '',a5,1x,a4,2(1x,a9))')  &
                    mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (l14scale) then
                  if (l14frac) then
                    write(iout,'(''mm3buck energy '',a4,1x,a3,2(1x,a9))')  &
                      mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                  else
                    write(iout,'(''mm3buck energy '',a4,1x,f6.4,2(1x,a9))')  &
                      mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                  endif
                else
                  write(iout,'(''mm3buck energy '',a4,2(1x,a9))')  &
                    mmword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              endif
            endif
            ...
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''mm3buck '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                    mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
                  write(iout,'(''mm3buck '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                    mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                write(iout,'(''mm3buck '',a5,1x,a4,2(1x,a9))')  &
                  mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
              endif
            else
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''mm3buck'',1x,a4,1x,a3,2(1x,a9))')  &
                    mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
                  write(iout,'(''mm3buck'',1x,a4,1x,f6.4,2(1x,a9))')  &
                    mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                write(iout,'(''mm3buck'',1x,a4,2(1x,a9))')  &
                  mmword,(botyword(nbotyptr(j)),j=1,nboty)
              endif
            endif
          endif
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''mm3stretch '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''mm3stretch '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''mm3stretch '',a5,1x,a4,2(1x,a9))')  &
              mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
          endif
        else
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''mm3stretch '',a4,1x,a3,2(1x,a9))')  &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''mm3stretch '',a4,1x,f6.4,2(1x,a9))')  &
                mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''mm3stretch '',a4,2(1x,a9))')  &
              mmword,(botyword(nbotyptr(j)),j=1,nboty)
          endif
        endif
        if (lfit) then
        ...
        if (lcombine(i)) then
          if (nmptr.gt.0) then
            if (l14scale) then
              if (l14frac) then
                if (ncombipower(i).eq.6) then
                  write(iout,'(''lenn epsilon c1c2eq4 combine '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                    im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.2) then
                  write(iout,'(''lenn epsilon c1c2eq4 geometric '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                    im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.1) then
                  write(iout,'(''lenn epsilon c1c2eq4 product '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                    im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (ncombipower(i).eq.6) then
                  write(iout,'(''lenn epsilon c1c2eq4 combine '',i2,1x,i2,1x,a5,1x,a4,1x,f6.4,2(1x,a9))') &
                    im,in,mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.2) then
                  write(iout,'(''lenn epsilon c1c2eq4 geometric '',i2,1x,i2,1x,a5,1x,a4,1x,f6.4,2(1x,a9))') &
                    im,in,mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.1) then
                  write(iout,'(''lenn epsilon c1c2eq4 product '',i2,1x,i2,1x,a5,1x,a4,1x,f6.4,2(1x,a9))') &
                    im,in,mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                endif
              endif
            else
              if (ncombipower(i).eq.6) then
                write(iout,'(''lenn epsilon c1c2eq4 combine '',i2,1x,i2,1x,a5,1x,a4,2(1x,a9))') &
                  im,in,mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
              elseif (ncombipower(i).eq.2) then
                write(iout,'(''lenn epsilon c1c2eq4 geometric '',i2,1x,i2,1x,a5,1x,a4,2(1x,a9))') &
                  im,in,mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
              elseif (ncombipower(i).eq.1) then
                write(iout,'(''lenn epsilon c1c2eq4 product '',i2,1x,i2,1x,a5,1x,a4,2(1x,a9))') &
                  im,in,mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
              endif
            endif
          else
            if (l14scale) then
              if (l14frac) then
                if (ncombipower(i).eq.6) then
                  write(iout,'(''lenn epsilon c1c2eq4 combine '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))') &
                    im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.2) then
                  write(iout,'(''lenn epsilon c1c2eq4 geometric '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))') &
                    im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.1) then
                  write(iout,'(''lenn epsilon c1c2eq4 product '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))') &
                    im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                if (ncombipower(i).eq.6) then
                  write(iout,'(''lenn epsilon c1c2eq4 combine '',i2,1x,i2,1x,a4,1x,f6.4,2(1x,a9))') &
                    im,in,mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.2) then
                  write(iout,'(''lenn epsilon c1c2eq4 geometric '',i2,1x,i2,1x,a4,1x,f6.4,2(1x,a9))') &
                    im,in,mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                elseif (ncombipower(i).eq.1) then
                  write(iout,'(''lenn epsilon c1c2eq4 product '',i2,1x,i2,1x,a4,1x,f6.4,2(1x,a9))') &
                    im,in,mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                endif
              endif
            else
              if (ncombipower(i).eq.6) then
                write(iout,'(''lenn epsilon c1c2eq4 combine '',i2,1x,i2,1x,a4,2(1x,a9))') &
                  im,in,mmword,(botyword(nbotyptr(j)),j=1,nboty)
              elseif (ncombipower(i).eq.2) then
                write(iout,'(''lenn epsilon c1c2eq4 geometric '',i2,1x,i2,1x,a4,2(1x,a9))') &
                  im,in,mmword,(botyword(nbotyptr(j)),j=1,nboty)
              elseif (ncombipower(i).eq.1) then
                write(iout,'(''lenn epsilon c1c2eq4 product '',i2,1x,i2,1x,a4,2(1x,a9))') &
                  im,in,mmword,(botyword(nbotyptr(j)),j=1,nboty)
              endif
            endif
          endif
          ...
          if (nmptr.gt.0) then
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''lenn epsilon c1c2eq4 '',i2,1x,i2,1x,a5,1x,a4,1x,a3,2(1x,a9))') &
                  im,in,mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
                write(iout,'(''lenn epsilon c1c2eq4 '',i2,1x,i2,1x,a5,1x,a4,1x,f6.4,2(1x,a9))') &
                  im,in,mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
              endif
            else
              write(iout,'(''lenn epsilon c1c2eq4 '',i2,1x,i2,1x,a5,1x,a4,2(1x,a9))') &
                im,in,mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''lenn epsilon c1c2eq4 '',i2,1x,i2,1x,a4,1x,a3,2(1x,a9))') &
                  im,in,mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
                write(iout,'(''lenn epsilon c1c2eq4 '',i2,1x,i2,1x,a4,1x,f6.4,2(1x,a9))') &
                  im,in,mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
              endif
            else
              write(iout,'(''lenn epsilon c1c2eq4 '',i2,1x,i2,1x,a4,2(1x,a9))') &
                im,in,mmword,(botyword(nbotyptr(j)),j=1,nboty)
            endif
          endif
          if (lfit) then
...
!  
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''buffer_lj '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''buffer_lj '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''buffer_lj '',a5,1x,a4,2(1x,a9))')  &
              mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
          endif
        else
          if (l14scale) then 
            if (l14frac) then
              write(iout,'(''buffer_lj'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''buffer_lj'',1x,a4,1x,f6.4,2(1x,a9))') &
                mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''buffer_lj'',1x,a4,2(1x,a9))') &
              mmword,(botyword(nbotyptr(j)),j=1,nboty)
          endif
        endif
        if (lfit) then
        ...
        if (leshift(i)) then
          if (lgshift(i)) then
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''slater grad '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                    mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
                  write(iout,'(''slater grad '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                    mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                write(iout,'(''slater grad '',a5,1x,a4,2(1x,a9))')  &
                  mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
              endif
            else
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''slater grad '',a4,1x,a3,2(1x,a9))')  &
                    mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
                  write(iout,'(''slater grad '',a4,1x,f6.4,2(1x,a9))')  &
                    mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                write(iout,'(''slater grad '',a4,2(1x,a9))')  &
                  mmword,(botyword(nbotyptr(j)),j=1,nboty)
              endif
            endif
          else
            if (nmptr.gt.0) then
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''slater energy '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                    mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
                  write(iout,'(''slater energy '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                    mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                write(iout,'(''slater energy '',a5,1x,a4,2(1x,a9))')  &
                  mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
              endif
            else
              if (l14scale) then
                if (l14frac) then
                  write(iout,'(''slater energy '',a4,1x,a3,2(1x,a9))')  &
                    mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
                else
                  write(iout,'(''slater energy '',a4,1x,f6.4,2(1x,a9))')  &
                    mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
                endif
              else
                write(iout,'(''slater energy '',a4,2(1x,a9))')  &
                  mmword,(botyword(nbotyptr(j)),j=1,nboty)
              endif
            endif
          endif
          ...
          if (nmptr.gt.0) then
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''slater '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                  mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
                write(iout,'(''slater '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                  mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
              endif
            else
              write(iout,'(''slater '',a5,1x,a4,2(1x,a9))')  &
                mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            if (l14scale) then
              if (l14frac) then
                write(iout,'(''slater'',1x,a4,1x,a3,2(1x,a9))')  &
                  mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
              else
                write(iout,'(''slater'',1x,a4,1x,f6.4,2(1x,a9))')  &
                  mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
              endif
            else
              write(iout,'(''slater'',1x,a4,2(1x,a9))')  &
                mmword,(botyword(nbotyptr(j)),j=1,nboty)
            endif
          endif
        endif
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''j2 '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''j2 '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''j2 '',a5,1x,a4,2(1x,a9))')  &
              mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
          endif
        else
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''j2 '',a4,1x,a3,2(1x,a9))')  &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''j2 '',a4,1x,f6.4,2(1x,a9))')  &
                mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''j2 '',a4,2(1x,a9))')  &
              mmword,(botyword(nbotyptr(j)),j=1,nboty)
          endif
        endif
        if (lfit) then
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''sw2gen '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''sw2gen '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''sw2gen '',a5,1x,a4,2(1x,a9))')  &
              mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
          endif
        else
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''sw2gen'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''sw2gen'',1x,a4,1x,f6.4,2(1x,a9))') &
                mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''sw2gen'',1x,a4,2(1x,a9))') &
              mmword,(botyword(nbotyptr(j)),j=1,nboty)
          endif
        endif
        if (lfit) then
...
!
        if (nmptr.gt.0) then
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''screened_coulomb '',a5,1x,a4,1x,a3,2(1x,a9))')  &
                mword(nmptr),mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''screened_coulomb '',a5,1x,a4,1x,f6.4,2(1x,a9))')  &
                mword(nmptr),mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''screened_coulomb '',a5,1x,a4,2(1x,a9))')  &
              mword(nmptr),mmword,(botyword(nbotyptr(j)),j=1,nboty)
          endif
        else
          if (l14scale) then
            if (l14frac) then
              write(iout,'(''screened_coulomb'',1x,a4,1x,a3,2(1x,a9))') &
                mmword,scaleword,(botyword(nbotyptr(j)),j=1,nboty)
            else
              write(iout,'(''screened_coulomb'',1x,a4,1x,f6.4,2(1x,a9))') &
                mmword,scale14(i),(botyword(nbotyptr(j)),j=1,nboty)
            endif
          else
            write(iout,'(''screened_coulomb'',1x,a4,2(1x,a9))') &
              mmword,(botyword(nbotyptr(j)),j=1,nboty)
          endif
        endif
        if (lfit) then
