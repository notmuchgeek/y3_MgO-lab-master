...
!
!  Check whether geometry has gone wrong
!
  if (iflag.eq.-2) then
    funct1 = ssqlst + 100.0_dp  ! Set return value of funct1 so that okf is false
    okf = .false.
    goto 200
  endif
!
