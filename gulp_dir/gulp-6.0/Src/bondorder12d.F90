...
!
    if (lgrad1) then
      if (ldsl) then
        ...
        if (lilocal) then
          call d1add(i,maxneigh,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nboatomRptr,d1i,.false.,.false.)
        endif
      endif
      if (lgrad2) then
        if (ldsl) then
          ...
          call d2addddm(i,maxneigh,nneigh,neighno,xneigh,yneigh,zneigh,nfreeatom,nboatomRptr,nr1,d1i,d2i,.false.)
        endif
      endif
    endif
  enddo iloop
