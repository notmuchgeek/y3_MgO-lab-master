  subroutine projfork3dm(nforkl,nptrfork,nptrforl,d34,d34r, &
...
!  matrix block in a four-body interaction. Version without 
!  iocptr as an argument for distributed memory version.
!
!   5/17 Created from projfork3
!   2/18 Trace added
!
!  Conditions of use:
!
