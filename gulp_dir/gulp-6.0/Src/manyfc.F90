...
!
!  10/14 Created from manyp
!   1/15 Calls to reallocate corrected to reflect this subroutine name
!   1/15 Correction to indices of derivatives for i.ne.j case
...
!  12/20 Correction to locating potentials when Baskes present
!
!  Conditions of use:
!
...
!
  ...
  if (status/=0) call outofmemory('manyfc','npotl')
!
...
!
              elseif (nptype(npot).eq.45.or.nptype(npot).eq.55) then
                lvalidij = .true.
                rk = 1.0_dp/r
...
!
          if (i.ne.j) then
            d2cell(ix,jx,ncindm) = d2cell(ix,jx,ncindm) - deriv2(1)
            d2cell(ix,jy,ncindm) = d2cell(ix,jy,ncindm) - deriv2(2)
            d2cell(ix,jz,ncindm) = d2cell(ix,jz,ncindm) - deriv2(3)
            d2cell(iy,jx,ncindm) = d2cell(iy,jx,ncindm) - deriv2(2)
            d2cell(iy,jy,ncindm) = d2cell(iy,jy,ncindm) - deriv2(4)
            d2cell(iy,jz,ncindm) = d2cell(iy,jz,ncindm) - deriv2(5)
            d2cell(iz,jx,ncindm) = d2cell(iz,jx,ncindm) - deriv2(3)
            d2cell(iz,jy,ncindm) = d2cell(iz,jy,ncindm) - deriv2(5)
            d2cell(iz,jz,ncindm) = d2cell(iz,jz,ncindm) - deriv2(6)
          endif
        endif
!******************************************************************
...
!
              if (i.ne.j) then
                d2cell(ix,jx,ncindm) = d2cell(ix,jx,ncindm) - dt1r*drhototik(1)*drhototij(1) - dt2r*drhototijk2(1,1)
                d2cell(ix,jy,ncindm) = d2cell(ix,jy,ncindm) - dt1r*drhototik(1)*drhototij(2) - dt2r*drhototijk2(2,1)
                d2cell(ix,jz,ncindm) = d2cell(ix,jz,ncindm) - dt1r*drhototik(1)*drhototij(3) - dt2r*drhototijk2(3,1)
                d2cell(iy,jx,ncindm) = d2cell(iy,jx,ncindm) - dt1r*drhototik(2)*drhototij(1) - dt2r*drhototijk2(1,2)
                d2cell(iy,jy,ncindm) = d2cell(iy,jy,ncindm) - dt1r*drhototik(2)*drhototij(2) - dt2r*drhototijk2(2,2)
                d2cell(iy,jz,ncindm) = d2cell(iy,jz,ncindm) - dt1r*drhototik(2)*drhototij(3) - dt2r*drhototijk2(3,2)
                d2cell(iz,jx,ncindm) = d2cell(iz,jx,ncindm) - dt1r*drhototik(3)*drhototij(1) - dt2r*drhototijk2(1,3)
                d2cell(iz,jy,ncindm) = d2cell(iz,jy,ncindm) - dt1r*drhototik(3)*drhototij(2) - dt2r*drhototijk2(2,3)
                d2cell(iz,jz,ncindm) = d2cell(iz,jz,ncindm) - dt1r*drhototik(3)*drhototij(3) - dt2r*drhototijk2(3,3)
              endif
            else
              dt1r = rscrhoi3*ofctijk
...
!
              if (i.ne.j) then
                d2cell(ix,jx,ncindm) = d2cell(ix,jx,ncindm) - dt1r*drhototik(1)*drhototij(1)
                d2cell(ix,jy,ncindm) = d2cell(ix,jy,ncindm) - dt1r*drhototik(1)*drhototij(2)
                d2cell(ix,jz,ncindm) = d2cell(ix,jz,ncindm) - dt1r*drhototik(1)*drhototij(3)
                d2cell(iy,jx,ncindm) = d2cell(iy,jx,ncindm) - dt1r*drhototik(2)*drhototij(1)
                d2cell(iy,jy,ncindm) = d2cell(iy,jy,ncindm) - dt1r*drhototik(2)*drhototij(2)
                d2cell(iy,jz,ncindm) = d2cell(iy,jz,ncindm) - dt1r*drhototik(2)*drhototij(3)
                d2cell(iz,jx,ncindm) = d2cell(iz,jx,ncindm) - dt1r*drhototik(3)*drhototij(1)
                d2cell(iz,jy,ncindm) = d2cell(iz,jy,ncindm) - dt1r*drhototik(3)*drhototij(2)
                d2cell(iz,jz,ncindm) = d2cell(iz,jz,ncindm) - dt1r*drhototik(3)*drhototij(3)
              endif
            endif
!
!  j-k
...
!
              if (i.ne.j) then
                d2cell(ix,jx,ncindm) = d2cell(ix,jx,ncindm) + dt1r*drhototjk(1)*drhototji(1) + dt2r*drhototjik2(1,1)
                d2cell(ix,jy,ncindm) = d2cell(ix,jy,ncindm) + dt1r*drhototjk(2)*drhototji(1) + dt2r*drhototjik2(1,2)
                d2cell(ix,jz,ncindm) = d2cell(ix,jz,ncindm) + dt1r*drhototjk(3)*drhototji(1) + dt2r*drhototjik2(1,3)
                d2cell(iy,jx,ncindm) = d2cell(iy,jx,ncindm) + dt1r*drhototjk(1)*drhototji(2) + dt2r*drhototjik2(2,1)
                d2cell(iy,jy,ncindm) = d2cell(iy,jy,ncindm) + dt1r*drhototjk(2)*drhototji(2) + dt2r*drhototjik2(2,2)
                d2cell(iy,jz,ncindm) = d2cell(iy,jz,ncindm) + dt1r*drhototjk(3)*drhototji(2) + dt2r*drhototjik2(2,3)
                d2cell(iz,jx,ncindm) = d2cell(iz,jx,ncindm) + dt1r*drhototjk(1)*drhototji(3) + dt2r*drhototjik2(3,1)
                d2cell(iz,jy,ncindm) = d2cell(iz,jy,ncindm) + dt1r*drhototjk(2)*drhototji(3) + dt2r*drhototjik2(3,2)
                d2cell(iz,jz,ncindm) = d2cell(iz,jz,ncindm) + dt1r*drhototjk(3)*drhototji(3) + dt2r*drhototjik2(3,3)
              endif
            else
              dt1r = rscrhoj3*ofctijk
...
!
              if (i.ne.j) then
                d2cell(ix,jx,ncindm) = d2cell(ix,jx,ncindm) + dt1r*drhototjk(1)*drhototji(1)
                d2cell(ix,jy,ncindm) = d2cell(ix,jy,ncindm) + dt1r*drhototjk(2)*drhototji(1)
                d2cell(ix,jz,ncindm) = d2cell(ix,jz,ncindm) + dt1r*drhototjk(3)*drhototji(1)
                d2cell(iy,jx,ncindm) = d2cell(iy,jx,ncindm) + dt1r*drhototjk(1)*drhototji(2)
                d2cell(iy,jy,ncindm) = d2cell(iy,jy,ncindm) + dt1r*drhototjk(2)*drhototji(2)
                d2cell(iy,jz,ncindm) = d2cell(iy,jz,ncindm) + dt1r*drhototjk(3)*drhototji(2)
                d2cell(iz,jx,ncindm) = d2cell(iz,jx,ncindm) + dt1r*drhototjk(1)*drhototji(3)
                d2cell(iz,jy,ncindm) = d2cell(iz,jy,ncindm) + dt1r*drhototjk(2)*drhototji(3)
                d2cell(iz,jz,ncindm) = d2cell(iz,jz,ncindm) + dt1r*drhototjk(3)*drhototji(3)
              endif
            endif
!
!  i-k/j-k
...
!
              if (i.ne.j) then
                d2cell(ix,jx,ncindm) = d2cell(ix,jx,ncindm) + dt1r*drhototki(1)*drhototkj(1) + dt2r*drhototkij2(1,1)
                d2cell(ix,jy,ncindm) = d2cell(ix,jy,ncindm) + dt1r*drhototki(1)*drhototkj(2) + dt2r*drhototkij2(1,2)
                d2cell(ix,jz,ncindm) = d2cell(ix,jz,ncindm) + dt1r*drhototki(1)*drhototkj(3) + dt2r*drhototkij2(1,3)
                d2cell(iy,jx,ncindm) = d2cell(iy,jx,ncindm) + dt1r*drhototki(2)*drhototkj(1) + dt2r*drhototkij2(2,1)
                d2cell(iy,jy,ncindm) = d2cell(iy,jy,ncindm) + dt1r*drhototki(2)*drhototkj(2) + dt2r*drhototkij2(2,2)
                d2cell(iy,jz,ncindm) = d2cell(iy,jz,ncindm) + dt1r*drhototki(2)*drhototkj(3) + dt2r*drhototkij2(2,3)
                d2cell(iz,jx,ncindm) = d2cell(iz,jx,ncindm) + dt1r*drhototki(3)*drhototkj(1) + dt2r*drhototkij2(3,1)
                d2cell(iz,jy,ncindm) = d2cell(iz,jy,ncindm) + dt1r*drhototki(3)*drhototkj(2) + dt2r*drhototkij2(3,2)
                d2cell(iz,jz,ncindm) = d2cell(iz,jz,ncindm) + dt1r*drhototki(3)*drhototkj(3) + dt2r*drhototkij2(3,3)
              endif
            else
              dt1r = rscrhok3*ofctijk
...
!
              if (i.ne.j) then
                d2cell(ix,jx,ncindm) = d2cell(ix,jx,ncindm) + dt1r*drhototki(1)*drhototkj(1)
                d2cell(ix,jy,ncindm) = d2cell(ix,jy,ncindm) + dt1r*drhototki(1)*drhototkj(2)
                d2cell(ix,jz,ncindm) = d2cell(ix,jz,ncindm) + dt1r*drhototki(1)*drhototkj(3)
                d2cell(iy,jx,ncindm) = d2cell(iy,jx,ncindm) + dt1r*drhototki(2)*drhototkj(1)
                d2cell(iy,jy,ncindm) = d2cell(iy,jy,ncindm) + dt1r*drhototki(2)*drhototkj(2)
                d2cell(iy,jz,ncindm) = d2cell(iy,jz,ncindm) + dt1r*drhototki(2)*drhototkj(3)
                d2cell(iz,jx,ncindm) = d2cell(iz,jx,ncindm) + dt1r*drhototki(3)*drhototkj(1)
                d2cell(iz,jy,ncindm) = d2cell(iz,jy,ncindm) + dt1r*drhototki(3)*drhototkj(2)
                d2cell(iz,jz,ncindm) = d2cell(iz,jz,ncindm) + dt1r*drhototki(3)*drhototkj(3)
              endif
            endif
          enddo
!***************************
...
!
  ...
  if (status/=0) call deallocate_error('manyfc','npotl')
!
!  Unscale density
!
  call eamscalescrho(-1_i4)
