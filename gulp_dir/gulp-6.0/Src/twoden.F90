  subroutine twoden(nor,nor0,npots,npotl,sctrm1,sctrm2,lorder12loc)
!
...
!  lorder12loc= if .true. then order is i-j as expected, but if false then i & j are switched
!
...
!************************
          if (lMEAMden) then
            ...
            call meamrho(nspec1(npot),nptyp1(npot),nspec2(npot),nptyp2(npot),r,rpot(npot),xtmp(k),ytmp(k),ztmp(k), &
                         ...
                         1.0_dp,1.0_dp,lorder12loc,.false.,.false.,.false.,twopot(1,npot))
...
!*******************************************************************
  subroutine twoden1(nor,nor0,dist1,x1,y1,z1,npots,npotl,sctrm1,sctrm2,lorder12loc)
!
...
!
!  Julian Gale, CIC, Curtin University, April 2009
!
  use realvectors
  implicit none
!
...
!
  call twoden(nor,nor0,npots,npotl,sctrm1,sctrm2,lorder12loc)
!
