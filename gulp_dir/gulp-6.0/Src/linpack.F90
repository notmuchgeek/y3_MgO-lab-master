...
!     fortran dabs,cdabs,dcmplx,conjg,abs,mod
!
!     internal variables.
!
...
!              1 by 1
!
           a(k,k) = dcmplx(1.0_dp/dble(a(k,k)),0.0_dp)
           if (km1 .lt. 1) go to 170
...
160             continue
              a(k,k) = a(k,k) &
                + dcmplx(dble(zdotc(km1,work,1_i4,a(1,k),1_i4)), &
                    0.0_dp)
170          continue
           kstep = 1
        go to 220
...
!
           ...
           akkp1 = a(k,k+1)/t
           d = t*(ak*akp1 - 1.0_dp)
           a(k,k) = dcmplx(akp1/d,0.0_dp)
           a(k+1,k+1) = dcmplx(ak/d,0.0_dp)
           a(k,k+1) = -akkp1/d
           if (km1 .lt. 1) go to 210
...
190             continue
              a(k+1,k+1) = a(k+1,k+1) &
                + dcmplx(dble(zdotc(km1,work,1_i4, &
                    a(1,k+1),1_i4)),0.0_dp)
...
!     fortran dabs,dmax1,dcmplx,conjg,sqrt
!
!     internal variables
!
...
!
        do 130 jj = 1, km1
           ...
           a(j,j) = dcmplx(dble(a(j,j)),0.0_dp)
           a(j,k) = mulk
130       continue
!
!           set the pivot array.
