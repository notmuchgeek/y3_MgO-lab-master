  subroutine smbody(eqeq,lgrad1,lgrad2,nor,nor0,factor,qli,qlj,nati,natj,nqri,nqrj)
!
...
!     
  ...
  integer(i4), intent(in)    :: nqri
  integer(i4), intent(in)    :: nqrj
...
#ifdef TRACE
  call trace_in('smbody')
#endif
!***************************************
!  Calculate exponents for s orbitals  *
!***************************************
  zetai = zetarange(nqri,nati,neemtype)
  zetaj = zetarange(nqrj,natj,neemtype)
  znuci = znucrange(nqri,nati,neemtype)
  znucj = znucrange(nqrj,natj,neemtype)
!************************
!  Loop over distances  *
!************************
  do i = nor0,nor
...
!  Wrapper for smbody
!*********************************************************************
  subroutine smbody1(eqeq,lgrad1,lgrad2,nor,nor0,dist1,deriv1,deriv21, &
    factor,qli,qlj,nati,natj,nqri,nqrj,d1i1,d1j1,d2i21,d2ij1,d2j21)
!
...
!  Call qeqbody
!
  call smbody(eqeq,lgrad1,lgrad2,nor,nor0,factor,qli,qlj,nati,natj,nqri,nqrj)
!
