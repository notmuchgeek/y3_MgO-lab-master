...
!
  ...
  real(dp) D(N),E2(N)
  real(dp) B,C,F,G,H,P,R,S,T,epsilon,e_pythag
!
...
!
!     Calls e_pythag for DSQRT(A*A + B*B) .
!
!     Questions and comments should be directed to Burton S. Garbow,
!     Mathematics and Computer Science Div, Argonne National Laboratory
!
...
!     especially on the VAX and other machines where epsilon(1.0_dp)**2
...
!
  ...
  real(dp) c,c2,c3,dl1,el1,f,g,h,p,r,s,s2,tst1,tst2,e_pythag
!
...
!                     determined after 30 iterations.
!
!     calls e_pythag for sqrt(a*a + b*b) .
!
!     questions and comments should be directed to burton s. garbow,
!     mathematics and computer science div, argonne national laboratory
!
...
!
  ...
  real(dp) f,g,h,fi,gi,hh,si,scale,e_pythag
!
!     this subroutine is a translation of a complex analogue of
