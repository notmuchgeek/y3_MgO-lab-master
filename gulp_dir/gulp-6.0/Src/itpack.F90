...
!
!          echall, itjcg , permat,
!          itperror, pervec, pjac  , prbndx, sbelm , scal  ,
!          unscal
!
...
340 idgts = iparm(12)
  ...
  call itperror(n,ndim,maxnz,jcoef,coef,rhs,u,wksp,digit1,digit2,idgts)
!
...
50 continue
  ...
  subroutine itperror(n,ndim,maxnz,jcoef,coef,rhs,u,work,digit1,digit2,idgts)
!
!     itperror computes the residual, r = rhs - a*u.  the user
...
!
  integer(i4) :: n, ndim, maxnz
  integer(i4) :: jcoef(ndim,maxnz)
  real(dp)    :: coef(ndim,maxnz),b(n),c(n)
!
  integer(i4) :: maxm1
!
