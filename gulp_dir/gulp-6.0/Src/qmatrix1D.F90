...
!
  ...
  call emfunc(nemorder,u,+xji,1.0_dp,yji,zji,a,e1,dh1,d2h1,d3h1,lgrad1,lgrad2,.false.)
  call emfunc(nemorder,u,-xji,-1.0_dp,yji,zji,a,e2,dh2,d2h2,d3h1,lgrad1,lgrad2,.false.)
  qme = qme + (e1 + e2)
  if (lgrad1) then
