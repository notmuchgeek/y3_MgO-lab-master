  subroutine projfork3dd(nforkl,nptrfork,nptrforl,d34,d34r, &
    dt11,dt21,dt31,dt22,dt32,dt33,dsqh,lzsisa)
!
...
!
!  As per projfork3d but iocptr is not passed
!
!   5/17 Created from projfork3d
!   2/18 Trace added
!
!  Conditions of use:
!
