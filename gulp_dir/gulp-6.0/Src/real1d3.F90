...
!   4/15 Tidy of variable declarations
!   2/18 Trace added
...
!  E-M term
!
! DEBUG - rigid molecules needed handling!
    call emfuncs(nemorder,u,+x,1.0_dp,y,z,0.0_dp,a,e1,dh1,d2h1,dh1s,d2h1s,d2h1m, &
                 d3h1,d3h1m,.true.,.true.,.true.)
    call emfuncs(nemorder,u,-x,-1.0_dp,y,z,0.0_dp,a,e2,dh2,d2h2,dh2s,d2h2s,d2h2m, &
                 d3h2,d3h2m,.true.,.true.,.true.)
    d2 = qij*angstoev
