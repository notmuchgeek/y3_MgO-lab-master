  subroutine projd3ad(mcvminloc,mcvmaxloc,d3r,d3i,d3,d3rs,d3is,d3s,lstr, &
    ...
    d34rs,d34is,nforkl,nptrfork,nptrforl,maxd2,dsqh,lzsisa)
!
...
!  NB: derv2 is flipped relative to projd0
!
!   5/17 Created from projd3a
!   2/18 Trace added
!
!  Conditions of use:
!
...
!
        call projthbk3dm(i,j,nmanyk,nptrmanyk,d33,d33r,d33i, &
          ...
          dt22,dt32,dt13,dt23,dt33,dsqh,lzsisa)
        if (nforkl.gt.0) then
          call projfork3dm(nforkl,nptrfork,nptrforl,d34, &
...
!
        ...
        if (nforkl.gt.0) then
          call projfork3dd(nforkl,nptrfork,nptrforl,d34,d34r,dii11,dii21,dii31,dii22,dii32,dii33, &
            dsqh,lzsisa)
        endif
        if (lstr) then
