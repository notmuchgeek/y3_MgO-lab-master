...
!
  ...
  character(len=maxwordlength)        :: xtlfile2
  character(len=maxwordlength)        :: xtlfilel
  integer(i4)                         :: i
  integer(i4)                         :: ii
  integer(i4)                         :: inat
  integer(i4)                         :: incf
...
!
      ...
      if (ncfg.gt.1) then
        write(ioout,'(''  XTL file written for configuration '',i4,'' as '',a)') ncf,trim(xtlfile2)
      else
        write(ioout,'(''  XTL file written as '',a)') trim(xtlfile2)
      endif
!**********************************************************************
