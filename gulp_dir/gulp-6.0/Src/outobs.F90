...
!
      ...
      if (nt.eq.9.or.nt.eq.13.or.nt.eq.14.or.nt.eq.29.or.nt.eq.32) then
        lfcphon(ncf) = .true.
...
!
          write(ioout,'(7x,i4,8x,a13,1x,f12.6,2x,f12.4,2x,i3,1x,a,''com'',3x,i4)') &
            i,nameobs(nt),fobs(i),weight(i),ind,namecrd(1),nobcfg(i)
...
!
          write(ioout,'(7x,i4,8x,a13,1x,f12.6,2x,f12.4,2x,i3,1x,a,''qtn'',3x,i4)') &
            i,nameobs(nt),fobs(i),weight(i),ind,namecrd(1),nobcfg(i)
