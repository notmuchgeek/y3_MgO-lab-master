...
!  Local variables
! 
  character(len=maxwordlength)    :: dlvfile2
  character(len=maxwordlength)    :: dlvfilel
...
!
    ...
    if (ncfg.gt.1) then
      write(ioout,'(''  STR file written for configuration '',i4,'' as '',a)') ncf,trim(dlvfile2)
    else
      write(ioout,'(''  STR file written as '',a)') trim(dlvfile2)
    endif
!*****************************
