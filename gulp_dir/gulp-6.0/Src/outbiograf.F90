...
!
  ...
  character(len=maxwordlength)  :: biofile2
  character(len=maxwordlength)  :: biofilel
...
!
    ...
    if (ncfg.gt.1) then
      write(ioout,'(''  Biograf file written for configuration '',i4,'' as '',a)') ncf,trim(biofile2)
    else
      write(ioout,'(''  Biograf file written as '',a)') trim(biofile2)
    endif
!**********************
!  Write out headers  *
!**********************
